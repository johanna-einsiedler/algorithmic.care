...
var Gt, gn = ((Gt = Pi).length === 1 && (Gt = function(e) {
  return function(t, i) {
    return Pi(e(t), i);
  };
}(Gt)), { left: function(e, t, i, s) {
  for (i == null && (i = 0), s == null && (s = e.length); i < s; ) {
    var n = i + s >>> 1;
    Gt(e[n], t) < 0 ? i = n + 1 : s = n;
  }
  return i;
}, right: function(e, t, i, s) {
  for (i == null && (i = 0), s == null && (s = e.length); i < s; ) {
    var n = i + s >>> 1;
    Gt(e[n], t) > 0 ? s = n : i = n + 1;
  }
  return i;
} });
const zs = gn.right;
function et(e, t) {
  ...
  if (t === void 0)
    ...
    let n = -1;
    for (let r of e)
      (r = t(r, ++n, e)) != null && (i === void 0 ? r >= r && (i = s = r) : (i > r && (i = r), s < r && (s = r)));
  }
  return [i, s];
}
function Ws(e, t, i) {
  e = +e, t = +t, i = (n = arguments.length) < 2 ? (t = e, e = 0, 1) : n < 3 ? 1 : +i;
  for (var s = -1, n = 0 | Math.max(0, Math.ceil((t - e) / i)), r = new Array(n); ++s < n; )
    r[s] = e + s * i;
  return r;
}
var He = Math.sqrt(50), Xe = Math.sqrt(10), Ke = Math.sqrt(2);
function Ut(e, t, i) {
  var s = (t - e) / Math.max(0, i), n = Math.floor(Math.log(s) / Math.LN10), r = s / Math.pow(10, n);
  return n >= 0 ? (r >= He ? 10 : r >= Xe ? 5 : r >= Ke ? 2 : 1) * Math.pow(10, n) : -Math.pow(10, -n) / (r >= He ? 10 : r >= Xe ? 5 : r >= Ke ? 2 : 1);
}
function D(e, t) {
  let i;
  if (t === void 0)
    ...
    let s = -1;
    for (let n of e)
      (n = t(n, ++s, e)) != null && (i < n || i === void 0 && n >= n) && (i = n);
  }
  return i;
}
function dt(e, t) {
...
var Re = 1, ze = 2, Qe = 3, Bt = 4, Ri = 1e-6;
function mn(e) {
...
function Fs(e, t) {
  var i = [], s = null, n = null, r = 6, a = 6, h = 3, l = e === Re || e === Bt ? -1 : 1, o = e === Bt || e === ze ? "x" : "y", c = e === Re || e === Qe ? mn : yn;
  function u(d) {
    var f = s ?? (t.ticks ? t.ticks.apply(t, i) : t.domain()), p = n ?? (t.tickFormat ? t.tickFormat.apply(t, i) : pn), g = Math.max(r, 0) + h, y = t.range(), m = +y[0] + 0.5, x = +y[y.length - 1] + 0.5, k = (t.bandwidth ? xn : An)(t.copy()), S = d.selection ? d.selection() : d, R = S.selectAll(".domain").data([null]), v = S.selectAll(".tick").data(f, t).order(), M = v.exit(), F = v.enter().append("g").attr("class", "tick"), E = v.select("line"), W = v.select("text");
    R = R.merge(R.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "currentColor")), v = v.merge(F), E = E.merge(F.append("line").attr("stroke", "currentColor").attr(o + "2", l * r)), W = W.merge(F.append("text").attr("fill", "currentColor").attr(o, l * g).attr("dy", e === Re ? "0em" : e === Qe ? "0.71em" : "0.32em")), d !== S && (R = R.transition(d), v = v.transition(d), E = E.transition(d), W = W.transition(d), M = M.transition(d).attr("opacity", Ri).attr("transform", function(z) {
      return isFinite(z = k(z)) ? c(z) : this.getAttribute("transform");
    }), F.attr("opacity", Ri).attr("transform", function(z) {
      var w = this.parentNode.__axis;
      return c(w && isFinite(w = w(z)) ? w : k(z));
    })), M.remove(), R.attr("d", e === Bt || e == ze ? a ? "M" + l * a + "," + m + "H0.5V" + x + "H" + l * a : "M0.5," + m + "V" + x : a ? "M" + m + "," + l * a + "V0.5H" + x + "V" + l * a : "M" + m + ",0.5H" + x), v.attr("opacity", 1).attr("transform", function(z) {
      return c(k(z));
    }), E.attr(o + "2", l * r), W.attr(o, l * g).text(p), S.filter(vn).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", e === ze ? "start" : e === Bt ? "end" : "middle"), S.each(function() {
      this.__axis = k;
    });
  }
  return u.scale = function(d) {
    ...
    return i = Pe.call(arguments), u;
  }, u.tickArguments = function(d) {
    return arguments.length ? (i = d == null ? [] : Pe.call(d), u) : i.slice();
  }, u.tickValues = function(d) {
    return arguments.length ? (s = d == null ? null : Pe.call(d), u) : s && s.slice();
  }, u.tickFormat = function(d) {
    return arguments.length ? (n = d, u) : n;
  }, u.tickSize = function(d) {
    return arguments.length ? (r = a = +d, u) : r;
...
function X(e, t) {
  var i = e + "", s = i.length;
  return s < t ? new Array(t - s + 1).join(0) + i : i;
}
function bn(e) {
  var t, i = e.getUTCHours(), s = e.getUTCMinutes(), n = e.getUTCSeconds(), r = e.getUTCMilliseconds();
  return isNaN(e) ? "Invalid Date" : ((t = e.getUTCFullYear()) < 0 ? "-" + X(-t, 6) : t > 9999 ? "+" + X(t, 6) : X(t, 4)) + "-" + X(e.getUTCMonth() + 1, 2) + "-" + X(e.getUTCDate(), 2) + (r ? "T" + X(i, 2) + ":" + X(s, 2) + ":" + X(n, 2) + "." + X(r, 3) + "Z" : n ? "T" + X(i, 2) + ":" + X(s, 2) + ":" + X(n, 2) + "Z" : s || i ? "T" + X(i, 2) + ":" + X(s, 2) + "Z" : "");
}
function js(e) {
  var t = new RegExp('["' + e + `
\r]`), i = e.charCodeAt(0);
  function s(h, l) {
    var o, c = [], u = h.length, d = 0, f = 0, p = u <= 0, g = !1;
    function y() {
      if (p)
        return We;
      if (g)
      ...
      if (h.charCodeAt(S) === 34) {
        for (; d++ < u && h.charCodeAt(d) !== 34 || h.charCodeAt(++d) === 34; )
          ;
        return (x = d) >= u ? p = !0 : (k = h.charCodeAt(d++)) === 10 ? g = !0 : k === 13 && (g = !0, h.charCodeAt(d) === 10 && ++d), h.slice(S + 1, x - 1).replace(/""/g, '"');
      }
      for (; d < u; ) {
        if ((k = h.charCodeAt(x = d++)) === 10)
          g = !0;
        else if (k === 13)
          g = !0, h.charCodeAt(d) === 10 && ++d;
        else if (k !== i)
          continue;
        return h.slice(S, x);
      }
      return p = !0, h.slice(S, u);
    }
    for (h.charCodeAt(u - 1) === 10 && --u, h.charCodeAt(u - 1) === 13 && --u; (o = y()) !== We; ) {
      for (var m = []; o !== zi && o !== We; )
        m.push(o), o = y();
      l && (m = l(m, f++)) == null || c.push(m);
    }
    return c;
  }
  function n(h, l) {
  ...
  function r(h) {
    return h.map(a).join(e);
  }
  function a(h) {
    return h == null ? "" : h instanceof Date ? bn(h) : t.test(h += "") ? '"' + h.replace(/"/g, '""') + '"' : h;
  }
  return { parse: function(h, l) {
    var o, c, u = s(h, function(d, f) {
      if (o)
        return o(d, f - 1);
      c = d, o = l ? function(p, g) {
        var y = Wi(p);
        return function(m, x) {
          return g(y(m), x, p);
        };
  ...
  }, parseRows: s, format: function(h, l) {
    return l == null && (l = Fi(h)), [l.map(a).join(e)].concat(n(h, l)).join(`
`);
  }, formatBody: function(h, l) {
    return l == null && (l = Fi(h)), n(h, l).join(`
`);
...
function Es(e) {
  return function(t, i, s) {
    return arguments.length === 2 && typeof i == "function" && (s = i, i = void 0), function(n, r) {
      return fetch(n, r).then(Sn);
    }(t, i).then(function(n) {
      return e(n, s);
    });
  };
}
var bt = Es(kn), kt = Es(wn);
function Mn(e) {
  if (!e.ok)
    throw new Error(e.status + " " + e.statusText);
  return e.json();
...
function Cs(e, t) {
  return fetch(e, t).then(Mn);
}
function re(e, t) {
  if ((i = (e = t ? e.toExponential(t - 1) : e.toExponential()).indexOf("e")) < 0)
    return null;
  var i, s = e.slice(0, i);
  return [s.length > 1 ? s[0] + s.slice(2) : s, +e.slice(i + 1)];
}
function St(e) {
  return (e = re(Math.abs(e))) ? e[1] : NaN;
}
var Os, Pn = /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
function ae(e) {
  if (!(t = Pn.exec(e)))
    throw new Error("invalid format: " + e);
  var t;
  return new Ue({ fill: t[1], align: t[2], sign: t[3], symbol: t[4], zero: t[5], width: t[6], comma: t[7], precision: t[8] && t[8].slice(1), trim: t[9], type: t[10] });
}
function Ue(e) {
...
ae.prototype = Ue.prototype, Ue.prototype.toString = function() {
...
const Ei = { "%": function(e, t) {
  ...
  if (!i)
    return e + "";
  var s = i[0], n = i[1], r = n - (Os = 3 * Math.max(-8, Math.min(8, Math.floor(n / 3)))) + 1, a = s.length;
  return r === a ? s : r > a ? s + new Array(r - a + 1).join("0") : r > 0 ? s.slice(0, r) + "." + s.slice(r) : "0." + new Array(1 - r).join("0") + re(e, Math.max(0, t + r - 1))[0];
}, X: function(e) {
...
var Fe, rt, Gs, Oi = Array.prototype.map, Gi = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
function Rn(e) {
  var t, i, s = e.grouping === void 0 || e.thousands === void 0 ? Ci : (t = Oi.call(e.grouping, Number), i = e.thousands + "", function(d, f) {
    for (var p = d.length, g = [], y = 0, m = t[0], x = 0; p > 0 && m > 0 && (x + m + 1 > f && (m = Math.max(1, f - x)), g.push(d.substring(p -= m, p + m)), !((x += m + 1) > f)); )
      m = t[y = (y + 1) % t.length];
    return g.reverse().join(i);
  }), n = e.currency === void 0 ? "" : e.currency[0] + "", r = e.currency === void 0 ? "" : e.currency[1] + "", a = e.decimal === void 0 ? "." : e.decimal + "", h = e.numerals === void 0 ? Ci : function(d) {
    return function(f) {
      return f.replace(/[0-9]/g, function(p) {
        return d[+p];
      });
    };
  }(Oi.call(e.numerals, String)), l = e.percent === void 0 ? "%" : e.percent + "", o = e.minus === void 0 ? "-" : e.minus + "", c = e.nan === void 0 ? "NaN" : e.nan + "";
  function u(d) {
    var f = (d = ae(d)).fill, p = d.align, g = d.sign, y = d.symbol, m = d.zero, x = d.width, k = d.comma, S = d.precision, R = d.trim, v = d.type;
    v === "n" ? (k = !0, v = "g") : Ei[v] || (S === void 0 && (S = 12), R = !0, v = "g"), (m || f === "0" && p === "=") && (m = !0, f = "0", p = "=");
    var M = y === "$" ? n : y === "#" && /[boxX]/.test(v) ? "0" + v.toLowerCase() : "", F = y === "$" ? r : /[%p]/.test(v) ? l : "", E = Ei[v], W = /[defgprs%]/.test(v);
    function z(w) {
      var j, H, Z, C = M, G = F;
      if (v === "c")
        G = E(w) + G, w = "";
        ...
        var ot = (w = +w) < 0;
        if (w = isNaN(w) ? c : E(Math.abs(w), S), R && (w = function(_) {
          t:
            for (var ut, Ct = _.length, $ = 1, tt = -1; $ < Ct; ++$)
              switch (_[$]) {
                case ".":
                  tt = ut = $;
                  break;
          ...
          return tt > 0 ? _.slice(0, tt) + _.slice(ut + 1) : _;
        }(w)), ot && +w == 0 && (ot = !1), C = (ot ? g === "(" ? g : o : g === "-" || g === "(" ? "" : g) + C, G = (v === "s" ? Gi[8 + Os / 3] : "") + G + (ot && g === "(" ? ")" : ""), W) {
          for (j = -1, H = w.length; ++j < H; )
            if (48 > (Z = w.charCodeAt(j)) || Z > 57) {
              G = (Z === 46 ? a + w.slice(j + 1) : w.slice(j)) + G, w = w.slice(0, j);
              break;
            }
        }
      }
      k && !m && (w = s(w, 1 / 0));
      var lt = C.length + w.length + G.length, I = lt < x ? new Array(x - lt + 1).join(f) : "";
      switch (k && m && (w = s(I + w, I.length ? x - G.length : 1 / 0), I = ""), p) {
        case "<":
          w = C + w + G + I;
          break;
        case "=":
          ...
          break;
        case "^":
          w = I.slice(0, lt = I.length >> 1) + C + w + G + I.slice(lt);
          break;
        default:
          w = I + C + w + G;
      }
    ...
    return S = S === void 0 ? 6 : /[gprs]/.test(v) ? Math.max(1, Math.min(21, S)) : Math.max(0, Math.min(20, S)), z.toString = function() {
      return d + "";
    }, z;
  }
  return { format: u, formatPrefix: function(d, f) {
    var p = u(((d = ae(d)).type = "f", d)), g = 3 * Math.max(-8, Math.min(8, Math.floor(St(f) / 3))), y = Math.pow(10, -g), m = Gi[8 + g / 3];
    return function(x) {
      return p(y * x) + m;
    };
  } };
...
Fe = Rn({ decimal: ".", thousands: ",", grouping: [3], currency: ["$", ""], minus: "-" }), rt = Fe.format, Gs = Fe.formatPrefix;
const Ii = Symbol("implicit");
function ye() {
  var e = /* @__PURE__ */ new Map(), t = [], i = [], s = Ii;
  function n(r) {
    var a = r + "", h = e.get(a);
    if (!h) {
      if (s !== Ii)
  ...
  return n.domain = function(r) {
    ...
    for (const a of r) {
      const h = a + "";
      e.has(h) || e.set(h, t.push(a));
    }
    return n;
  }, n.range = function(r) {
    return arguments.length ? (i = Array.from(r), n) : i.slice();
  }, n.unknown = function(r) {
    return arguments.length ? (s = r, n) : s;
  }, n.copy = function() {
    return ye(t, i).unknown(s);
  }, ci.apply(n, arguments), n;
}
function Qt() {
  var e, t, i = ye().unknown(void 0), s = i.domain, n = i.range, r = 0, a = 1, h = !1, l = 0, o = 0, c = 0.5;
  function u() {
    var d = s().length, f = a < r, p = f ? a : r, g = f ? r : a;
    e = (g - p) / Math.max(1, d - l + 2 * o), h && (e = Math.floor(e)), p += (g - p - e * (d - l)) * c, t = e * (1 - l), h && (p = Math.round(p), t = Math.round(t));
    var y = Ws(d).map(function(m) {
      return p + e * m;
    });
  ...
  return delete i.unknown, i.domain = function(d) {
    ...
    return arguments.length ? ([r, a] = d, r = +r, a = +a, u()) : [r, a];
  }, i.rangeRound = function(d) {
    return [r, a] = d, r = +r, a = +a, h = !0, u();
    ...
    return arguments.length ? (l = Math.min(1, o = +d), u()) : l;
  }, i.paddingInner = function(d) {
    return arguments.length ? (l = Math.min(1, d), u()) : l;
  }, i.paddingOuter = function(d) {
    return arguments.length ? (o = +d, u()) : o;
  }, i.align = function(d) {
    return arguments.length ? (c = Math.max(0, Math.min(1, d)), u()) : c;
  }, i.copy = function() {
    return Qt(s(), [r, a]).round(h).paddingInner(l).paddingOuter(o).align(c);
...
function Li() {
  return Is(Qt.apply(null, arguments).paddingInner(1));
}
function ee(e, t, i) {
...
var yt = 0.7, Mt = 1 / yt, Ft = "\\s*([+-]?\\d+)\\s*", qt = "\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)\\s*", ht = "\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)%\\s*", zn = /^#([0-9a-f]{3,8})$/, Wn = new RegExp("^rgb\\(" + [Ft, Ft, Ft] + "\\)$"), Fn = new RegExp("^rgb\\(" + [ht, ht, ht] + "\\)$"), jn = new RegExp("^rgba\\(" + [Ft, Ft, Ft, qt] + "\\)$"), En = new RegExp("^rgba\\(" + [ht, ht, ht, qt] + "\\)$"), Cn = new RegExp("^hsl\\(" + [qt, ht, ht] + "\\)$"), On = new RegExp("^hsla\\(" + [qt, ht, ht, qt] + "\\)$"), Bi = { aliceblue: 15792383, antiquewhite: 16444375, aqua: 65535, aquamarine: 8388564, azure: 15794175, beige: 16119260, bisque: 16770244, black: 0, blanchedalmond: 16772045, blue: 255, blueviolet: 9055202, brown: 10824234, burlywood: 14596231, cadetblue: 6266528, chartreuse: 8388352, chocolate: 13789470, coral: 16744272, cornflowerblue: 6591981, cornsilk: 16775388, crimson: 14423100, cyan: 65535, darkblue: 139, darkcyan: 35723, darkgoldenrod: 12092939, darkgray: 11119017, darkgreen: 25600, darkgrey: 11119017, darkkhaki: 12433259, darkmagenta: 9109643, darkolivegreen: 5597999, darkorange: 16747520, darkorchid: 10040012, darkred: 9109504, darksalmon: 15308410, darkseagreen: 9419919, darkslateblue: 4734347, darkslategray: 3100495, darkslategrey: 3100495, darkturquoise: 52945, darkviolet: 9699539, deeppink: 16716947, deepskyblue: 49151, dimgray: 6908265, dimgrey: 6908265, dodgerblue: 2003199, firebrick: 11674146, floralwhite: 16775920, forestgreen: 2263842, fuchsia: 16711935, gainsboro: 14474460, ghostwhite: 16316671, gold: 16766720, goldenrod: 14329120, gray: 8421504, green: 32768, greenyellow: 11403055, grey: 8421504, honeydew: 15794160, hotpink: 16738740, indianred: 13458524, indigo: 4915330, ivory: 16777200, khaki: 15787660, lavender: 15132410, lavenderblush: 16773365, lawngreen: 8190976, lemonchiffon: 16775885, lightblue: 11393254, lightcoral: 15761536, lightcyan: 14745599, lightgoldenrodyellow: 16448210, lightgray: 13882323, lightgreen: 9498256, lightgrey: 13882323, lightpink: 16758465, lightsalmon: 16752762, lightseagreen: 2142890, lightskyblue: 8900346, lightslategray: 7833753, lightslategrey: 7833753, lightsteelblue: 11584734, lightyellow: 16777184, lime: 65280, limegreen: 3329330, linen: 16445670, magenta: 16711935, maroon: 8388608, mediumaquamarine: 6737322, mediumblue: 205, mediumorchid: 12211667, mediumpurple: 9662683, mediumseagreen: 3978097, mediumslateblue: 8087790, mediumspringgreen: 64154, mediumturquoise: 4772300, mediumvioletred: 13047173, midnightblue: 1644912, mintcream: 16121850, mistyrose: 16770273, moccasin: 16770229, navajowhite: 16768685, navy: 128, oldlace: 16643558, olive: 8421376, olivedrab: 7048739, orange: 16753920, orangered: 16729344, orchid: 14315734, palegoldenrod: 15657130, palegreen: 10025880, paleturquoise: 11529966, palevioletred: 14381203, papayawhip: 16773077, peachpuff: 16767673, peru: 13468991, pink: 16761035, plum: 14524637, powderblue: 11591910, purple: 8388736, rebeccapurple: 6697881, red: 16711680, rosybrown: 12357519, royalblue: 4286945, saddlebrown: 9127187, salmon: 16416882, sandybrown: 16032864, seagreen: 3050327, seashell: 16774638, sienna: 10506797, silver: 12632256, skyblue: 8900331, slateblue: 6970061, slategray: 7372944, slategrey: 7372944, snow: 16775930, springgreen: 65407, steelblue: 4620980, tan: 13808780, teal: 32896, thistle: 14204888, tomato: 16737095, turquoise: 4251856, violet: 15631086, wheat: 16113331, white: 16777215, whitesmoke: 16119285, yellow: 16776960, yellowgreen: 10145074 };
function Ti() {
...
function Vt(e) {
  var t, i;
  return e = (e + "").trim().toLowerCase(), (t = zn.exec(e)) ? (i = t[1].length, t = parseInt(t[1], 16), i === 6 ? Ni(t) : i === 3 ? new T(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | 240 & t, (15 & t) << 4 | 15 & t, 1) : i === 8 ? new T(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (255 & t) / 255) : i === 4 ? new T(t >> 12 & 15 | t >> 8 & 240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | 240 & t, ((15 & t) << 4 | 15 & t) / 255) : null) : (t = Wn.exec(e)) ? new T(t[1], t[2], t[3], 1) : (t = Fn.exec(e)) ? new T(255 * t[1] / 100, 255 * t[2] / 100, 255 * t[3] / 100, 1) : (t = jn.exec(e)) ? Yi(t[1], t[2], t[3], t[4]) : (t = En.exec(e)) ? Yi(255 * t[1] / 100, 255 * t[2] / 100, 255 * t[3] / 100, t[4]) : (t = Cn.exec(e)) ? Di(t[1], t[2] / 100, t[3] / 100, 1) : (t = On.exec(e)) ? Di(t[1], t[2] / 100, t[3] / 100, t[4]) : Bi.hasOwnProperty(e) ? Ni(Bi[e]) : e === "transparent" ? new T(NaN, NaN, NaN, 0) : null;
}
function Ni(e) {
  return new T(e >> 16 & 255, e >> 8 & 255, 255 & e, 1);
}
function Yi(e, t, i, s) {
  return s <= 0 && (e = t = i = NaN), new T(e, t, i, s);
}
function Ls(e) {
  return e instanceof Wt || (e = Vt(e)), e ? new T((e = e.rgb()).r, e.g, e.b, e.opacity) : new T();
}
function _e(e, t, i, s) {
  return arguments.length === 1 ? Ls(e) : new T(e, t, i, s ?? 1);
}
function T(e, t, i, s) {
...
function Vi() {
  var e = this.opacity;
  return ((e = isNaN(e) ? 1 : Math.max(0, Math.min(1, e))) === 1 ? "rgb(" : "rgba(") + Math.max(0, Math.min(255, Math.round(this.r) || 0)) + ", " + Math.max(0, Math.min(255, Math.round(this.g) || 0)) + ", " + Math.max(0, Math.min(255, Math.round(this.b) || 0)) + (e === 1 ? ")" : ", " + e + ")");
}
function je(e) {
  return ((e = Math.max(0, Math.min(255, Math.round(e) || 0))) < 16 ? "0" : "") + e.toString(16);
}
function Di(e, t, i, s) {
  return s <= 0 ? e = t = i = NaN : i <= 0 || i >= 1 ? e = t = NaN : t <= 0 && (e = NaN), new nt(e, t, i, s);
}
function Hi(e) {
  if (e instanceof nt)
    return new nt(e.h, e.s, e.l, e.opacity);
  if (e instanceof Wt || (e = Vt(e)), !e)
    return new nt();
  if (e instanceof nt)
    return e;
  var t = (e = e.rgb()).r / 255, i = e.g / 255, s = e.b / 255, n = Math.min(t, i, s), r = Math.max(t, i, s), a = NaN, h = r - n, l = (r + n) / 2;
  return h ? (a = t === r ? (i - s) / h + 6 * (i < s) : i === r ? (s - t) / h + 2 : (t - i) / h + 4, h /= l < 0.5 ? r + n : 2 - r - n, a *= 60) : h = l > 0 && l < 1 ? 0 : a, new nt(a, h, l, e.opacity);
}
function nt(e, t, i, s) {
...
ee(Wt, Vt, { copy: function(e) {
  return Object.assign(new this.constructor(), this, e);
}, displayable: function() {
  return this.rgb().displayable();
}, hex: Ti, formatHex: Ti, formatHsl: function() {
  return Hi(this).formatHsl();
}, formatRgb: Zi, toString: Zi }), ee(T, _e, Je(Wt, { brighter: function(e) {
  return e = e == null ? Mt : Math.pow(Mt, e), new T(this.r * e, this.g * e, this.b * e, this.opacity);
}, darker: function(e) {
  return e = e == null ? yt : Math.pow(yt, e), new T(this.r * e, this.g * e, this.b * e, this.opacity);
}, rgb: function() {
  return this;
}, displayable: function() {
  return -0.5 <= this.r && this.r < 255.5 && -0.5 <= this.g && this.g < 255.5 && -0.5 <= this.b && this.b < 255.5 && 0 <= this.opacity && this.opacity <= 1;
}, hex: qi, formatHex: qi, formatRgb: Vi, toString: Vi })), ee(nt, function(e, t, i, s) {
  return arguments.length === 1 ? Hi(e) : new nt(e, t, i, s ?? 1);
}, Je(Wt, { brighter: function(e) {
  return e = e == null ? Mt : Math.pow(Mt, e), new nt(this.h, this.s, this.l * e, this.opacity);
}, darker: function(e) {
  return e = e == null ? yt : Math.pow(yt, e), new nt(this.h, this.s, this.l * e, this.opacity);
}, rgb: function() {
  var e = this.h % 360 + 360 * (this.h < 0), t = isNaN(e) || isNaN(this.s) ? 0 : this.s, i = this.l, s = i + (i < 0.5 ? i : 1 - i) * t, n = 2 * i - s;
  return new T(Ee(e >= 240 ? e - 240 : e + 120, n, s), Ee(e, n, s), Ee(e < 120 ? e + 240 : e - 120, n, s), this.opacity);
}, displayable: function() {
  return (0 <= this.s && this.s <= 1 || isNaN(this.s)) && 0 <= this.l && this.l <= 1 && 0 <= this.opacity && this.opacity <= 1;
}, formatHsl: function() {
  var e = this.opacity;
  return ((e = isNaN(e) ? 1 : Math.max(0, Math.min(1, e))) === 1 ? "hsl(" : "hsla(") + (this.h || 0) + ", " + 100 * (this.s || 0) + "%, " + 100 * (this.l || 0) + "%" + (e === 1 ? ")" : ", " + e + ")");
} }));
var Gn = Math.PI / 180, In = 180 / Math.PI, Bs = -0.14861, ui = 1.78277, di = -0.29227, Ae = -0.90649, Dt = 1.97294, Xi = Dt * Ae, Ki = Dt * ui, Qi = ui * di - Ae * Bs;
function $e(e, t, i, s) {
  return arguments.length === 1 ? function(n) {
    if (n instanceof At)
      return new At(n.h, n.s, n.l, n.opacity);
    n instanceof T || (n = Ls(n));
    var r = n.r / 255, a = n.g / 255, h = n.b / 255, l = (Qi * h + Xi * r - Ki * a) / (Qi + Xi - Ki), o = h - l, c = (Dt * (a - l) - di * o) / Ae, u = Math.sqrt(c * c + o * o) / (Dt * l * (1 - l)), d = u ? Math.atan2(c, o) * In - 120 : NaN;
    return new At(d < 0 ? d + 360 : d, u, l, n.opacity);
  }(e) : new At(e, t, i, s ?? 1);
}
function At(e, t, i, s) {
  this.h = +e, this.s = +t, this.l = +i, this.opacity = +s;
...
function Ln(e) {
  return (e = +e) == 1 ? jt : function(t, i) {
    return i - t ? function(s, n, r) {
      return s = Math.pow(s, r), n = Math.pow(n, r) - s, r = 1 / r, function(a) {
        return Math.pow(s + a * n, r);
      };
    }(t, i, e) : xe(isNaN(t) ? i : t);
  };
}
function jt(e, t) {
  var i = t - e;
  return i ? Ts(e, i) : xe(isNaN(e) ? t : e);
}
ee(At, $e, Je(Wt, { brighter: function(e) {
  return e = e == null ? Mt : Math.pow(Mt, e), new At(this.h, this.s, this.l * e, this.opacity);
}, darker: function(e) {
  return e = e == null ? yt : Math.pow(yt, e), new At(this.h, this.s, this.l * e, this.opacity);
}, rgb: function() {
  var e = isNaN(this.h) ? 0 : (this.h + 120) * Gn, t = +this.l, i = isNaN(this.s) ? 0 : this.s * t * (1 - t), s = Math.cos(e), n = Math.sin(e);
  return new T(255 * (t + i * (Bs * s + ui * n)), 255 * (t + i * (di * s + Ae * n)), 255 * (t + i * (Dt * s)), this.opacity);
} }));
const Ui = function e(t) {
  var i = Ln(t);
  function s(n, r) {
    var a = i((n = _e(n)).r, (r = _e(r)).r), h = i(n.g, r.g), l = i(n.b, r.b), o = jt(n.opacity, r.opacity);
    return function(c) {
      return n.r = a(c), n.g = h(c), n.b = l(c), n.opacity = o(c), n + "";
    };
  }
  return s.gamma = e, s;
}(1);
function Bn(e, t) {
  var i, s = t ? t.length : 0, n = e ? Math.min(s, e.length) : 0, r = new Array(n), a = new Array(s);
  for (i = 0; i < n; ++i)
    r[i] = fi(e[i], t[i]);
  for (; i < s; ++i)
    a[i] = t[i];
...
function Tn(e, t) {
  ...
  return t -= e = +e, function(s) {
    return i.setTime(e + t * s), i;
  };
}
function oe(e, t) {
...
function Zn(e, t) {
  var i, s = {}, n = {};
  for (i in e !== null && typeof e == "object" || (e = {}), t !== null && typeof t == "object" || (t = {}), t)
    i in e ? s[i] = fi(e[i], t[i]) : n[i] = t[i];
  return function(r) {
    for (i in s)
      n[i] = s[i](r);
    return n;
...
var ti = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, Ce = new RegExp(ti.source, "g");
function Nn(e, t) {
  var i, s, n, r = ti.lastIndex = Ce.lastIndex = 0, a = -1, h = [], l = [];
  for (e += "", t += ""; (i = ti.exec(e)) && (s = Ce.exec(t)); )
    (n = s.index) > r && (n = t.slice(r, n), h[a] ? h[a] += n : h[++a] = n), (i = i[0]) === (s = s[0]) ? h[a] ? h[a] += s : h[++a] = s : (h[++a] = null, l.push({ i: a, x: oe(i, s) })), r = Ce.lastIndex;
  return r < t.length && (n = t.slice(r), h[a] ? h[a] += n : h[++a] = n), h.length < 2 ? l[0] ? function(o) {
    return function(c) {
      return o(c) + "";
    };
  }(l[0].x) : function(o) {
...
function fi(e, t) {
  var i, s = typeof t;
  return t == null || s === "boolean" ? xe(t) : (s === "number" ? oe : s === "string" ? (i = Vt(t)) ? (t = i, Ui) : Nn : t instanceof Vt ? Ui : t instanceof Date ? Tn : Array.isArray(t) ? Bn : typeof t.valueOf != "function" && typeof t.toString != "function" || isNaN(t) ? Zn : oe)(e, t);
}
function Yn(e, t) {
  return t -= e = +e, function(i) {
...
function Ji(e) {
  return function t(i) {
    function s(n, r) {
      var a = e((n = $e(n)).h, (r = $e(r)).h), h = jt(n.s, r.s), l = jt(n.l, r.l), o = jt(n.opacity, r.opacity);
      return function(c) {
        return n.h = a(c), n.s = h(c), n.l = l(Math.pow(c, i)), n.opacity = o(c), n + "";
      };
    }
    return i = +i, s.gamma = t, s;
  }(1);
}
function qn(e) {
  return +e;
...
Ji(function(e, t) {
  var i = t - e;
  return i ? Ts(e, i > 180 || i < -180 ? i - 360 * Math.round(i / 360) : i) : xe(isNaN(e) ? t : e);
}), Ji(jt);
var _i = [0, 1];
function Pt(e) {
  return e;
...
function Vn(e, t, i) {
  var s = e[0], n = e[1], r = t[0], a = t[1];
  return n < s ? (s = ei(n, s), r = i(a, r)) : (s = ei(s, n), r = i(r, a)), function(h) {
    return r(s(h));
  };
}
function Dn(e, t, i) {
  var s = Math.min(e.length, t.length) - 1, n = new Array(s), r = new Array(s), a = -1;
  for (e[s] < e[0] && (e = e.slice().reverse(), t = t.slice().reverse()); ++a < s; )
    n[a] = ei(e[a], e[a + 1]), r[a] = i(t[a], t[a + 1]);
  return function(h) {
    var l = zs(e, h, 1, s) - 1;
    return r[l](n[l](h));
  };
...
function Hn() {
  var e, t, i, s, n, r, a = _i, h = _i, l = fi, o = Pt;
  function c() {
    var d = Math.min(a.length, h.length);
    return o !== Pt && (o = function(f, p) {
      var g;
      return f > p && (g = f, f = p, p = g), function(y) {
        return Math.max(f, Math.min(p, y));
      };
    }(a[0], a[d - 1])), s = d > 2 ? Dn : Vn, n = r = null, u;
  }
  function u(d) {
    return isNaN(d = +d) ? i : (n || (n = s(a.map(e), h, l)))(e(o(d)));
  }
  return u.invert = function(d) {
    return o(t((r || (r = s(h, a.map(e), oe)))(d)));
  }, u.domain = function(d) {
    return arguments.length ? (a = Array.from(d, qn), c()) : a.slice();
  }, u.range = function(d) {
    return arguments.length ? (h = Array.from(d), c()) : h.slice();
  }, u.rangeRound = function(d) {
    return h = Array.from(d), l = Yn, c();
  }, u.clamp = function(d) {
    return arguments.length ? (o = !!d || Pt, c()) : o !== Pt;
...
function Xn(e, t, i, s) {
  var n, r = function(h, l, o) {
    var c = Math.abs(l - h) / Math.max(0, o), u = Math.pow(10, Math.floor(Math.log(c) / Math.LN10)), d = c / u;
    return d >= He ? u *= 10 : d >= Xe ? u *= 5 : d >= Ke && (u *= 2), l < h ? -u : u;
  }(e, t, i);
  switch ((s = ae(s ?? ",f")).type) {
    case "s":
      var a = Math.max(Math.abs(e), Math.abs(t));
      return s.precision != null || isNaN(n = function(h, l) {
        return Math.max(0, 3 * Math.max(-8, Math.min(8, Math.floor(St(l) / 3))) - St(Math.abs(h)));
      }(r, a)) || (s.precision = n), Gs(s, a);
    case "":
    case "e":
    case "g":
    case "p":
    case "r":
      s.precision != null || isNaN(n = function(h, l) {
        return h = Math.abs(h), l = Math.abs(l) - h, Math.max(0, St(l) - St(h)) + 1;
      }(r, Math.max(Math.abs(e), Math.abs(t)))) || (s.precision = n - (s.type === "e"));
      break;
    case "f":
    case "%":
      s.precision != null || isNaN(n = function(h) {
        return Math.max(0, -St(Math.abs(h)));
...
function Kn(e) {
  ...
  return e.ticks = function(i) {
    ...
    return function(n, r, a) {
      ...
      if (a = +a, (n = +n) == (r = +r) && a > 0)
        return [n];
      if ((h = r < n) && (l = n, n = r, r = l), (c = Ut(n, r, a)) === 0 || !isFinite(c))
        return [];
      if (c > 0)
        for (n = Math.ceil(n / c), r = Math.floor(r / c), o = new Array(l = Math.ceil(r - n + 1)); ++u < l; )
          o[u] = (n + u) * c;
      else
        for (n = Math.floor(n * c), r = Math.ceil(r * c), o = new Array(l = Math.ceil(n - r + 1)); ++u < l; )
          o[u] = (n - u) / c;
      return h && o.reverse(), o;
    }(s[0], s[s.length - 1], i ?? 10);
  }, e.tickFormat = function(i, s) {
    var n = t();
    return Xn(n[0], n[n.length - 1], i ?? 10, s);
  }, e.nice = function(i) {
    i == null && (i = 10);
    var s, n = t(), r = 0, a = n.length - 1, h = n[r], l = n[a];
    return l < h && (s = h, h = l, l = s, s = r, r = a, a = s), (s = Ut(h, l, i)) > 0 ? s = Ut(h = Math.floor(h / s) * s, l = Math.ceil(l / s) * s, i) : s < 0 && (s = Ut(h = Math.ceil(h * s) / s, l = Math.floor(l * s) / s, i)), s > 0 ? (n[r] = Math.floor(h / s) * s, n[a] = Math.ceil(l / s) * s, t(n)) : s < 0 && (n[r] = Math.ceil(h * s) / s, n[a] = Math.floor(l * s) / s, t(n)), e;
  }, e;
}
function O() {
  var e = Hn()(Pt, Pt);
  return e.copy = function() {
    return t = e, O().domain(t.domain()).range(t.range()).interpolate(t.interpolate()).clamp(t.clamp()).unknown(t.unknown());
    var t;
  }, ci.apply(e, arguments), Kn(e);
}
var ii = "http://www.w3.org/1999/xhtml";
const $i = { svg: "http://www.w3.org/2000/svg", xhtml: ii, xlink: "http://www.w3.org/1999/xlink", xml: "http://www.w3.org/XML/1998/namespace", xmlns: "http://www.w3.org/2000/xmlns/" };
function Zs(e) {
  var t = e += "", i = t.indexOf(":");
...
function ts(e) {
  var t = Zs(e);
  return (t.local ? Un : Qn)(t);
}
function Jn() {
}
function es(e) {
  return e == null ? Jn : function() {
...
le.prototype = { constructor: le, appendChild: function(e) {
...
var ss = "$";
function $n(e, t, i, s, n, r) {
  for (var a, h = 0, l = t.length, o = r.length; h < o; ++h)
    (a = t[h]) ? (a.__data__ = r[h], s[h] = a) : i[h] = new le(e, r[h]);
  for (; h < l; ++h)
    (a = t[h]) && (n[h] = a);
}
function th(e, t, i, s, n, r, a) {
  var h, l, o, c = {}, u = t.length, d = r.length, f = new Array(u);
  for (h = 0; h < u; ++h)
    (l = t[h]) && (f[h] = o = ss + a.call(l, l.__data__, h, t), o in c ? n[h] = l : c[o] = l);
  for (h = 0; h < d; ++h)
    (l = c[o = ss + a.call(e, r[h], h, r)]) ? (s[h] = l, l.__data__ = r[h], c[o] = null) : i[h] = new le(e, r[h]);
  for (h = 0; h < u; ++h)
    (l = t[h]) && c[f[h]] === l && (n[h] = l);
}
function eh(e, t) {
...
function Vs(e, t) {
  for (var i = gi(e), s = -1, n = t.length; ++s < n; )
    i.add(t[s]);
}
function Ds(e, t) {
  for (var i = gi(e), s = -1, n = t.length; ++s < n; )
...
function mh(e, t) {
  return function() {
    (t.apply(this, arguments) ? Vs : Ds)(this, e);
  };
}
function yh() {
  this.textContent = "";
...
var Hs = {}, ie = null;
typeof document < "u" && ("onmouseenter" in document.documentElement || (Hs = { mouseenter: "mouseover", mouseleave: "mouseout" }));
function Wh(e, t, i) {
  return e = Xs(e, t, i), function(s) {
    var n = s.relatedTarget;
    n && (n === this || 8 & n.compareDocumentPosition(this)) || e.call(this, s);
  };
}
function Xs(e, t, i) {
  return function(s) {
...
function Fh(e) {
  return function() {
    var t = this.__on;
    if (t) {
      for (var i, s = 0, n = -1, r = t.length; s < r; ++s)
        i = t[s], e.type && i.type !== e.type || i.name !== e.name ? t[++n] = i : this.removeEventListener(i.type, i.listener, i.capture);
      ++n ? t.length = n : delete this.__on;
    }
  };
}
function jh(e, t, i) {
  var s = Hs.hasOwnProperty(e.type) ? Wh : Xs;
  return function(n, r, a) {
    var h, l = this.__on, o = s(t, r, a);
    if (l) {
      for (var c = 0, u = l.length; c < u; ++c)
        if ((h = l[c]).type === e.type && h.name === e.name)
          return this.removeEventListener(h.type, h.listener, h.capture), this.addEventListener(h.type, h.listener = o, h.capture = i), void (h.value = t);
    }
    this.addEventListener(e.type, o, i), h = { type: e.type, name: e.name, value: t, listener: o, capture: i }, l ? l.push(h) : this.__on = [h];
  };
}
function Ks(e, t, i) {
  var s = Ns(e), n = s.CustomEvent;
...
function A(e) {
  return typeof e == "string" ? new Q([[document.querySelector(e)]], [document.documentElement]) : new Q([[e]], Qs);
}
Q.prototype = { constructor: Q, select: function(e) {
  typeof e != "function" && (e = es(e));
  for (var t = this._groups, i = t.length, s = new Array(i), n = 0; n < i; ++n)
    for (var r, a, h = t[n], l = h.length, o = s[n] = new Array(l), c = 0; c < l; ++c)
      (r = h[c]) && (a = e.call(r, r.__data__, c, h)) && ("__data__" in r && (a.__data__ = r.__data__), o[c] = a);
  return new Q(s, this._parents);
}, selectAll: function(e) {
  typeof e != "function" && (e = function(c) {
    return c == null ? _n : function() {
      return this.querySelectorAll(c);
    };
  }(e));
  for (var t = this._groups, i = t.length, s = [], n = [], r = 0; r < i; ++r)
    for (var a, h = t[r], l = h.length, o = 0; o < l; ++o)
      (a = h[o]) && (s.push(e.call(a, a.__data__, o, h)), n.push(a));
  return new Q(s, n);
}, filter: function(e) {
  typeof e != "function" && (e = function(c) {
    return function() {
  ...
  for (var t = this._groups, i = t.length, s = new Array(i), n = 0; n < i; ++n)
    for (var r, a = t[n], h = a.length, l = s[n] = [], o = 0; o < h; ++o)
      (r = a[o]) && e.call(r, r.__data__, o, a) && l.push(r);
  return new Q(s, this._parents);
}, data: function(e, t) {
  if (!e)
    return f = new Array(this.size()), o = -1, this.each(function(R) {
      f[++o] = R;
    }), f;
  var i = t ? th : $n, s = this._parents, n = this._groups;
  typeof e != "function" && (e = function(R) {
    return function() {
      return R;
    };
  }(e));
  for (var r = n.length, a = new Array(r), h = new Array(r), l = new Array(r), o = 0; o < r; ++o) {
    var c = s[o], u = n[o], d = u.length, f = e.call(c, c && c.__data__, o, s), p = f.length, g = h[o] = new Array(p), y = a[o] = new Array(p);
    i(c, u, g, y, l[o] = new Array(d), f, t);
    for (var m, x, k = 0, S = 0; k < p; ++k)
      if (m = g[k]) {
        for (k >= S && (S = k + 1); !(x = y[S]) && ++S < p; )
          ;
        m._next = x || null;
      }
  }
  return (a = new Q(a, s))._enter = h, a._exit = l, a;
}, enter: function() {
  return new Q(this._enter || this._groups.map(is), this._parents);
}, exit: function() {
  return new Q(this._exit || this._groups.map(is), this._parents);
}, join: function(e, t, i) {
  var s = this.enter(), n = this, r = this.exit();
  return s = typeof e == "function" ? e(s) : s.append(e + ""), t != null && (n = t(n)), i == null ? r.remove() : i(r), s && n ? s.merge(n).order() : n;
}, merge: function(e) {
  for (var t = this._groups, i = e._groups, s = t.length, n = i.length, r = Math.min(s, n), a = new Array(s), h = 0; h < r; ++h)
    for (var l, o = t[h], c = i[h], u = o.length, d = a[h] = new Array(u), f = 0; f < u; ++f)
      (l = o[f] || c[f]) && (d[f] = l);
  for (; h < s; ++h)
    a[h] = t[h];
  ...
  for (var e = this._groups, t = -1, i = e.length; ++t < i; )
    for (var s, n = e[t], r = n.length - 1, a = n[r]; --r >= 0; )
  ...
  for (var i = this._groups, s = i.length, n = new Array(s), r = 0; r < s; ++r) {
    for (var a, h = i[r], l = h.length, o = n[r] = new Array(l), c = 0; c < l; ++c)
      (a = h[c]) && (o[c] = a);
    o.sort(t);
  }
  return new Q(n, this._parents).order();
}, call: function() {
  var e = arguments[0];
  ...
  for (var t = this._groups, i = 0, s = t.length; i < s; ++i)
    for (var n, r = t[i], a = 0, h = r.length; a < h; ++a)
      (n = r[a]) && e.call(n, n.__data__, a, r);
  return this;
}, attr: function(e, t) {
  var i = Zs(e);
  ...
  return this.each((t == null ? i.local ? sh : ih : typeof t == "function" ? i.local ? ah : rh : i.local ? hh : nh)(i, t));
}, style: function(e, t, i) {
  return arguments.length > 1 ? this.each((t == null ? oh : typeof t == "function" ? ch : lh)(e, t, i ?? "")) : function(s, n) {
    return s.style.getPropertyValue(n) || Ns(s).getComputedStyle(s, null).getPropertyValue(n);
  }(this.node(), e);
  ...
  var i = Ys(e + "");
  if (arguments.length < 2) {
    for (var s = gi(this.node()), n = -1, r = i.length; ++n < r; )
      if (!s.contains(i[n]))
        return !1;
    return !0;
  }
  return this.each((typeof t == "function" ? mh : t ? gh : ph)(i, t));
}, text: function(e) {
  return arguments.length ? this.each(e == null ? yh : (typeof e == "function" ? xh : Ah)(e)) : this.node().textContent;
}, html: function(e) {
  return arguments.length ? this.each(e == null ? vh : (typeof e == "function" ? kh : bh)(e)) : this.node().innerHTML;
}, raise: function() {
  return this.each(wh);
}, lower: function() {
  return this.each(Sh);
}, append: function(e) {
  var t = typeof e == "function" ? e : ts(e);
  return this.select(function() {
    return this.appendChild(t.apply(this, arguments));
  });
}, insert: function(e, t) {
  var i = typeof e == "function" ? e : ts(e), s = t == null ? Mh : typeof t == "function" ? t : es(t);
  return this.select(function() {
  ...
  var s, n, r = function(u) {
    return u.trim().split(/^|\s+/).map(function(d) {
      var f = "", p = d.indexOf(".");
      return p >= 0 && (f = d.slice(p + 1), d = d.slice(0, p)), { type: d, name: f };
    });
  }(e + ""), a = r.length;
  if (!(arguments.length < 2)) {
    for (h = t ? jh : Fh, i == null && (i = !1), s = 0; s < a; ++s)
      this.each(h(r[s], t, i));
    return this;
  }
  var h = this.node().__on;
  if (h) {
    for (var l, o = 0, c = h.length; o < c; ++o)
      for (s = 0, l = h[o]; s < a; ++s)
        if ((n = r[s]).type === l.type && n.name === l.name)
          return l.value;
  }
}, dispatch: function(e, t) {
  return this.each((typeof t == "function" ? Ch : Eh)(e, t));
} };
var Oh = 0;
function ns() {
  this._ = "@" + (++Oh).toString(36);
}
function Gh() {
  for (var e, t = ie; e = t.sourceEvent; )
    t = e;
  return t;
}
function wt(e) {
  var t = Gh();
  return t.changedTouches && (t = t.changedTouches[0]), function(i, s) {
    var n = i.ownerSVGElement || i;
    if (n.createSVGPoint) {
      var r = n.createSVGPoint();
      return r.x = s.clientX, r.y = s.clientY, [(r = r.matrixTransform(i.getScreenCTM().inverse())).x, r.y];
    }
    var a = i.getBoundingClientRect();
    return [s.clientX - a.left - i.clientLeft, s.clientY - a.top - i.clientTop];
  }(e, t);
}
function P(e) {
  return typeof e == "string" ? new Q([document.querySelectorAll(e)], [document.documentElement]) : new Q([e ?? []], Qs);
}
ns.prototype = { constructor: ns, get: function(e) {
...
function Oe(e, t, i) {
  if (e && e.length) {
    const [s, n] = t, r = Math.PI / 180 * i, a = Math.cos(r), h = Math.sin(r);
    e.forEach((l) => {
      const [o, c] = l;
      l[0] = (o - s) * a - (c - n) * h + s, l[1] = (o - s) * h + (c - n) * a + n;
    });
  }
}
function Et(e) {
...
const Jt = { A: 7, a: 7, C: 6, c: 6, H: 1, h: 1, L: 2, l: 2, M: 2, m: 2, Q: 4, q: 4, S: 4, s: 4, T: 4, t: 2, V: 1, v: 1, Z: 0, z: 0 };
let Ih = class {
  constructor(e) {
    this.COMMAND = 0, this.NUMBER = 1, this.EOD = 2, this.segments = [], this.parseData(e), this.processPoints();
  }
  tokenize(e) {
    const t = new Array();
    for (; e !== ""; )
      if (e.match(/^([ \t\r\n,]+)/))
        ...
        t[t.length] = { type: this.COMMAND, text: RegExp.$1 }, e = e.substr(RegExp.$1.length);
      else {
        if (!e.match(/^(([-+]?[0-9]+(\.[0-9]*)?|[-+]?\.[0-9]+)([eE][-+]?[0-9]+)?)/))
          return [];
        t[t.length] = { type: this.NUMBER, text: `${parseFloat(RegExp.$1)}` }, e = e.substr(RegExp.$1.length);
      }
    return t[t.length] = { type: this.EOD, text: "" }, t;
  }
  parseData(e) {
    const t = this.tokenize(e);
    let i = 0, s = t[i], n = "BOD";
    for (this.segments = new Array(); !Ge(s, this.EOD); ) {
      let r;
      const a = new Array();
      if (n === "BOD") {
        if (s.text !== "M" && s.text !== "m")
          return void this.parseData("M0,0" + e);
        i++, r = Jt[s.text], n = s.text;
      } else
        Ge(s, this.NUMBER) ? r = Jt[n] : (i++, r = Jt[s.text], n = s.text);
      if (i + r < t.length) {
        for (let h = i; h < i + r; h++) {
          const l = t[h];
          if (!Ge(l, this.NUMBER))
            return void console.error("Param not a number: " + n + "," + l.text);
          a[a.length] = +l.text;
        }
        if (typeof Jt[n] != "number")
          return void console.error("Bad segment: " + n);
        {
          const h = { key: n, data: a };
          this.segments.push(h), i += r, s = t[i], n === "M" && (n = "L"), n === "m" && (n = "l");
        }
      } else
  ...
  get closed() {
    if (this._closed === void 0) {
      ...
      for (const e of this.segments)
        e.key.toLowerCase() === "z" && (this._closed = !0);
    }
    return this._closed;
  }
  processPoints() {
    ...
    for (let i = 0; i < this.segments.length; i++) {
      ...
      switch (s.key) {
        ...
        case "l":
        case "t":
          s.point = [s.data[0] + t[0], s.data[1] + t[1]];
          break;
        case "H":
          s.point = [s.data[0], t[1]];
          break;
        case "h":
          s.point = [s.data[0] + t[0], t[1]];
          break;
        case "V":
          s.point = [t[0], s.data[0]];
          break;
        case "v":
          s.point = [t[0], s.data[0] + t[1]];
          break;
        case "z":
        case "Z":
          e && (s.point = [e[0], e[1]]);
        ...
        case "C":
          ...
          break;
        case "c":
          s.point = [s.data[4] + t[0], s.data[5] + t[1]];
          break;
        case "S":
        case "Q":
        ...
        case "s":
        case "q":
          s.point = [s.data[2] + t[0], s.data[3] + t[1]];
          break;
        case "A":
          s.point = [s.data[5], s.data[6]];
          break;
        case "a":
          s.point = [s.data[5] + t[0], s.data[6] + t[1]];
      }
      s.key !== "m" && s.key !== "M" || (e = null), s.point && (t = s.point, e || (e = s.point)), s.key !== "z" && s.key !== "Z" || (e = null);
    }
  }
};
class hs {
  constructor(t) {
    this._position = [0, 0], this._first = null, this.bezierReflectionPoint = null, this.quadReflectionPoint = null, this.parsed = new Ih(t);
  }
  get segments() {
  ...
  get linearPoints() {
    if (!this._linearPoints) {
      ...
      for (const s of this.parsed.segments) {
        ...
        (n !== "m" && n !== "z" || (i.length && (t.push(i), i = []), n !== "z")) && s.point && i.push(s.point);
      }
      i.length && (t.push(i), i = []), this._linearPoints = t;
    }
  ...
  setPosition(t, i) {
    this._position = [t, i], this._first || (this._first = [t, i]);
  }
  get position() {
...
class Lh {
  constructor(t, i, s, n, r, a) {
    if (this._segIndex = 0, this._numSegs = 0, this._rx = 0, this._ry = 0, this._sinPhi = 0, this._cosPhi = 0, this._C = [0, 0], this._theta = 0, this._delta = 0, this._T = 0, this._from = t, t[0] === i[0] && t[1] === i[1])
      return;
    const h = Math.PI / 180;
    this._rx = Math.abs(s[0]), this._ry = Math.abs(s[1]), this._sinPhi = Math.sin(n * h), this._cosPhi = Math.cos(n * h);
    const l = this._cosPhi * (t[0] - i[0]) / 2 + this._sinPhi * (t[1] - i[1]) / 2, o = -this._sinPhi * (t[0] - i[0]) / 2 + this._cosPhi * (t[1] - i[1]) / 2;
    let c = 0;
    const u = this._rx * this._rx * this._ry * this._ry - this._rx * this._rx * o * o - this._ry * this._ry * l * l;
    if (u < 0) {
      const g = Math.sqrt(1 - u / (this._rx * this._rx * this._ry * this._ry));
      this._rx = this._rx * g, this._ry = this._ry * g, c = 0;
    } else
      c = (r === a ? -1 : 1) * Math.sqrt(u / (this._rx * this._rx * o * o + this._ry * this._ry * l * l));
    const d = c * this._rx * o / this._ry, f = -c * this._ry * l / this._rx;
    this._C = [0, 0], this._C[0] = this._cosPhi * d - this._sinPhi * f + (t[0] + i[0]) / 2, this._C[1] = this._sinPhi * d + this._cosPhi * f + (t[1] + i[1]) / 2, this._theta = this.calculateVectorAngle(1, 0, (l - d) / this._rx, (o - f) / this._ry);
    let p = this.calculateVectorAngle((l - d) / this._rx, (o - f) / this._ry, (-l - d) / this._rx, (-o - f) / this._ry);
    !a && p > 0 ? p -= 2 * Math.PI : a && p < 0 && (p += 2 * Math.PI), this._numSegs = Math.ceil(Math.abs(p / (Math.PI / 2))), this._delta = p / this._numSegs, this._T = 8 / 3 * Math.sin(this._delta / 4) * Math.sin(this._delta / 4) / Math.sin(this._delta / 2);
  }
  getNextSegment() {
    if (this._segIndex === this._numSegs)
      return null;
    const t = Math.cos(this._theta), i = Math.sin(this._theta), s = this._theta + this._delta, n = Math.cos(s), r = Math.sin(s), a = [this._cosPhi * this._rx * n - this._sinPhi * this._ry * r + this._C[0], this._sinPhi * this._rx * n + this._cosPhi * this._ry * r + this._C[1]], h = [this._from[0] + this._T * (-this._cosPhi * this._rx * i - this._sinPhi * this._ry * t), this._from[1] + this._T * (-this._sinPhi * this._rx * i + this._cosPhi * this._ry * t)], l = [a[0] + this._T * (this._cosPhi * this._rx * r + this._sinPhi * this._ry * n), a[1] + this._T * (this._sinPhi * this._rx * r - this._cosPhi * this._ry * n)];
    return this._theta = s, this._from = [a[0], a[1]], this._segIndex++, { cp1: h, cp2: l, to: a };
  }
  calculateVectorAngle(t, i, s, n) {
    const r = Math.atan2(i, t), a = Math.atan2(n, s);
    return a >= r ? a - r : 2 * Math.PI - (r - a);
  }
}
class Bh {
  constructor(t, i) {
    this.sets = t, this.closed = i;
  }
  fit(t) {
    const i = [];
    for (const n of this.sets) {
      ...
      i.push(this.reduce(n, a));
    }
    let s = "";
    for (const n of i) {
      for (let r = 0; r < n.length; r++) {
        const a = n[r];
        s += r === 0 ? "M" + a[0] + "," + a[1] : "L" + a[0] + "," + a[1];
      }
      this.closed && (s += "z ");
    }
    return s;
  ...
  reduce(t, i) {
    ...
    for (; s.length > i; ) {
      ...
      for (let a = 1; a < s.length - 1; a++) {
        const h = Et([s[a - 1], s[a]]), l = Et([s[a], s[a + 1]]), o = Et([s[a - 1], s[a + 1]]), c = (h + l + o) / 2, u = Math.sqrt(c * (c - h) * (c - l) * (c - o));
        (n < 0 || u < n) && (n = u, r = a);
      }
      if (!(r > 0))
        break;
...
function ve(e, t) {
  const i = [0, 0], s = Math.round(t.hachureAngle + 90);
  s && Oe(e, i, s);
  const n = function(r, a) {
    const h = [...r];
    h[0].join(",") !== h[h.length - 1].join(",") && h.push([h[0][0], h[0][1]]);
    const l = [];
    if (h && h.length > 2) {
      let o = a.hachureGap;
      o < 0 && (o = 4 * a.strokeWidth), o = Math.max(o, 0.1);
      const c = [];
      for (let f = 0; f < h.length - 1; f++) {
        const p = h[f], g = h[f + 1];
        if (p[1] !== g[1]) {
          const y = Math.min(p[1], g[1]);
          c.push({ ymin: y, ymax: Math.max(p[1], g[1]), x: y === p[1] ? p[0] : g[0], islope: (g[0] - p[0]) / (g[1] - p[1]) });
        }
      }
      if (c.sort((f, p) => f.ymin < p.ymin ? -1 : f.ymin > p.ymin ? 1 : f.x < p.x ? -1 : f.x > p.x ? 1 : f.ymax === p.ymax ? 0 : (f.ymax - p.ymax) / Math.abs(f.ymax - p.ymax)), !c.length)
        return l;
      let u = [], d = c[0].ymin;
      for (; u.length || c.length; ) {
        if (c.length) {
          let f = -1;
          for (let p = 0; p < c.length && !(c[p].ymin > d); p++)
            f = p;
          c.splice(0, f + 1).forEach((p) => {
            u.push({ s: d, edge: p });
          });
        }
        if (u = u.filter((f) => !(f.edge.ymax <= d)), u.sort((f, p) => f.edge.x === p.edge.x ? 0 : (f.edge.x - p.edge.x) / Math.abs(f.edge.x - p.edge.x)), u.length > 1)
          for (let f = 0; f < u.length; f += 2) {
            const p = f + 1;
            if (p >= u.length)
              break;
            const g = u[f].edge, y = u[p].edge;
            l.push([[Math.round(g.x), d], [Math.round(y.x), d]]);
          }
        d += o, u.forEach((f) => {
          f.edge.x = f.edge.x + o * f.edge.islope;
        });
      }
    }
    return l;
  }(e, t);
  return s && (Oe(e, i, -s), function(r, a, h) {
    const l = [];
    r.forEach((o) => l.push(...o)), Oe(l, a, h);
  }(n, i, -s)), n;
}
class pi {
  constructor(t) {
  ...
  fillPolygon(t, i) {
    return this._fillPolygon(t, i);
  }
  _fillPolygon(t, i, s = !1) {
    const n = ve(t, i);
  ...
  renderLines(t, i, s) {
    let n = [], r = null;
    for (const a of t)
      n = n.concat(this.helper.doubleLineOps(a[0][0], a[0][1], a[1][0], a[1][1], i)), s && r && (n = n.concat(this.helper.doubleLineOps(r[0], r[1], a[0][0], a[0][1], i))), r = a[1];
    return n;
  }
}
class Th extends pi {
  fillPolygon(t, i) {
    return this._fillPolygon(t, i, !0);
  }
}
class Zh extends pi {
  fillPolygon(t, i) {
    const s = this._fillPolygon(t, i), n = Object.assign({}, i, { hachureAngle: i.hachureAngle + 90 }), r = this._fillPolygon(t, n);
...
class Nh {
  ...
  fillPolygon(t, i) {
    const s = ve(t, i = Object.assign({}, i, { curveStepCount: 4, hachureAngle: 0, roughness: 1 }));
  ...
  dotsOnLines(t, i) {
    ...
    let r = i.fillWeight;
    r < 0 && (r = i.strokeWidth / 2);
    for (const a of t) {
      const h = Et(a) / n, l = Math.ceil(h) - 1, o = Math.atan((a[1][1] - a[0][1]) / (a[1][0] - a[0][0]));
      for (let c = 0; c < l; c++) {
        const u = n * (c + 1), d = u * Math.sin(o), f = u * Math.cos(o), p = [a[0][0] - f, a[0][1] + d], g = this.helper.randOffsetWithRange(p[0] - n / 4, p[0] + n / 4, i), y = this.helper.randOffsetWithRange(p[1] - n / 4, p[1] + n / 4, i), m = this.helper.ellipse(g, y, r, r, i);
        s = s.concat(m.ops);
      }
    }
...
class Yh {
  ...
  dashedLine(t, i) {
    ...
    let r = [];
    return t.forEach((a) => {
      const h = Et(a), l = Math.floor(h / (s + n)), o = (h + n - l * (s + n)) / 2;
      let c = a[0], u = a[1];
      c[0] > u[0] && (c = a[1], u = a[0]);
      const d = Math.atan((u[1] - c[1]) / (u[0] - c[0]));
      for (let f = 0; f < l; f++) {
        const p = f * (s + n), g = p + s, y = [c[0] + p * Math.cos(d) + o * Math.cos(d), c[1] + p * Math.sin(d) + o * Math.sin(d)], m = [c[0] + g * Math.cos(d) + o * Math.cos(d), c[1] + g * Math.sin(d) + o * Math.sin(d)];
        r = r.concat(this.helper.doubleLineOps(y[0], y[1], m[0], m[1], i));
      }
    }), r;
  }
}
class qh {
  ...
  fillPolygon(t, i) {
    const s = i.hachureGap < 0 ? 4 * i.strokeWidth : i.hachureGap, n = i.zigzagOffset < 0 ? s : i.zigzagOffset, r = ve(t, i = Object.assign({}, i, { hachureGap: s + n }));
    return { type: "fillSketch", ops: this.zigzagLines(r, n, i) };
  }
  zigzagLines(t, i, s) {
    let n = [];
    return t.forEach((r) => {
      const a = Et(r), h = Math.round(a / (2 * i));
      let l = r[0], o = r[1];
      l[0] > o[0] && (l = r[1], o = r[0]);
      const c = Math.atan((o[1] - l[1]) / (o[0] - l[0]));
      for (let u = 0; u < h; u++) {
        const d = 2 * u * i, f = 2 * (u + 1) * i, p = Math.sqrt(2 * Math.pow(i, 2)), g = [l[0] + d * Math.cos(c), l[1] + d * Math.sin(c)], y = [l[0] + f * Math.cos(c), l[1] + f * Math.sin(c)], m = [g[0] + p * Math.cos(c + Math.PI / 4), g[1] + p * Math.sin(c + Math.PI / 4)];
        n = n.concat(this.helper.doubleLineOps(g[0], g[1], m[0], m[1], s)), n = n.concat(this.helper.doubleLineOps(m[0], m[1], y[0], y[1], s));
      }
    }), n;
  }
}
...
const Dh = { randOffset: function(e, t) {
  return b(e, t);
}, randOffsetWithRange: function(e, t, i) {
  return ce(e, t, i);
}, ellipse: function(e, t, i, s, n) {
  return si(e, t, n, Js(i, s, n)).opset;
}, doubleLineOps: function(e, t, i, s, n) {
  return J(e, t, i, s, n);
} };
function Us(e, t, i, s, n) {
  return { type: "path", ops: J(e, t, i, s, n) };
}
function Ie(e, t, i) {
  const s = (e || []).length;
  if (s > 2) {
    let n = [];
    for (let r = 0; r < s - 1; r++)
      n = n.concat(J(e[r][0], e[r][1], e[r + 1][0], e[r + 1][1], i));
    return t && (n = n.concat(J(e[s - 1][0], e[s - 1][1], e[0][0], e[0][1], i))), { type: "path", ops: n };
  }
  return s === 2 ? Us(e[0][0], e[0][1], e[1][0], e[1][1], i) : { type: "path", ops: [] };
}
function Hh(e, t) {
  const i = ls(e, 1 * (1 + 0.2 * t.roughness), t), s = ls(e, 1.5 * (1 + 0.22 * t.roughness), t);
  return { type: "path", ops: i.concat(s) };
}
function Js(e, t, i) {
  const s = Math.sqrt(2 * Math.PI * Math.sqrt((Math.pow(e / 2, 2) + Math.pow(t / 2, 2)) / 2)), n = Math.max(i.curveStepCount, i.curveStepCount / Math.sqrt(200) * s), r = 2 * Math.PI / n;
  let a = Math.abs(e / 2), h = Math.abs(t / 2);
  const l = 1 - i.curveFitting;
  return a += b(a * l, i), h += b(h * l, i), { increment: r, rx: a, ry: h };
}
function si(e, t, i, s) {
  const [n, r] = cs(s.increment, e, t, s.rx, s.ry, 1, s.increment * ce(0.1, ce(0.4, 1, i), i), i), [a] = cs(s.increment, e, t, s.rx, s.ry, 1.5, 0, i), h = ue(n, null, i), l = ue(a, null, i);
  return { estimatedPoints: r, opset: { type: "path", ops: h.concat(l) } };
}
function rs(e, t, i, s, n, r, a, h, l) {
  const o = e, c = t;
  let u = Math.abs(i / 2), d = Math.abs(s / 2);
  u += b(0.01 * u, l), d += b(0.01 * d, l);
  let f = n, p = r;
  for (; f < 0; )
    f += 2 * Math.PI, p += 2 * Math.PI;
  p - f > 2 * Math.PI && (f = 0, p = 2 * Math.PI);
  const g = 2 * Math.PI / l.curveStepCount, y = Math.min(g / 2, (p - f) / 2), m = us(y, o, c, u, d, f, p, 1, l), x = us(y, o, c, u, d, f, p, 1.5, l);
  let k = m.concat(x);
  return a && (h ? (k = k.concat(J(o, c, o + u * Math.cos(f), c + d * Math.sin(f), l)), k = k.concat(J(o, c, o + u * Math.cos(p), c + d * Math.sin(p), l))) : (k.push({ op: "lineTo", data: [o, c] }), k.push({ op: "lineTo", data: [o + u * Math.cos(f), c + d * Math.sin(f)] }))), { type: "path", ops: k };
}
function as(e, t) {
  const i = [];
  if (e.length) {
    const s = t.maxRandomnessOffset || 0, n = e.length;
    if (n > 2) {
      i.push({ op: "move", data: [e[0][0] + b(s, t), e[0][1] + b(s, t)] });
      for (let r = 1; r < n; r++)
        i.push({ op: "lineTo", data: [e[r][0] + b(s, t), e[r][1] + b(s, t)] });
    }
  }
    ...
    if (!K[n])
      switch (n) {
        ...
        case "zigzag-line":
          ...
          break;
        default:
          n = "hachure", K[n] || (K[n] = new pi(s));
      }
    return K[n];
  }(t, Dh).fillPolygon(e, t);
}
function _s(e) {
  return e.randomizer || (e.randomizer = new Vh(e.seed || 0)), e.randomizer.next();
}
function ce(e, t, i) {
  return i.roughness * i.roughnessGain * (_s(i) * (t - e) + e);
}
function b(e, t) {
  return ce(-e, e, t);
}
function J(e, t, i, s, n) {
  const r = os(e, t, i, s, n, !0, !1), a = os(e, t, i, s, n, !0, !0);
  return r.concat(a);
}
function os(e, t, i, s, n, r, a) {
  const h = Math.pow(e - i, 2) + Math.pow(t - s, 2), l = Math.sqrt(h);
  n.roughnessGain = l < 200 ? 1 : l > 500 ? 0.4 : -16668e-7 * l + 1.233334;
  let o = n.maxRandomnessOffset || 0;
  o * o * 100 > h && (o = l / 10);
  const c = o / 2, u = 0.2 + 0.2 * _s(n);
  let d = n.bowing * n.maxRandomnessOffset * (s - t) / 200, f = n.bowing * n.maxRandomnessOffset * (e - i) / 200;
  d = b(d, n), f = b(f, n);
  const p = [], g = () => b(c, n), y = () => b(o, n);
  return r && (a ? p.push({ op: "move", data: [e + g(), t + g()] }) : p.push({ op: "move", data: [e + b(o, n), t + b(o, n)] })), a ? p.push({ op: "bcurveTo", data: [d + e + (i - e) * u + g(), f + t + (s - t) * u + g(), d + e + 2 * (i - e) * u + g(), f + t + 2 * (s - t) * u + g(), i + g(), s + g()] }) : p.push({ op: "bcurveTo", data: [d + e + (i - e) * u + y(), f + t + (s - t) * u + y(), d + e + 2 * (i - e) * u + y(), f + t + 2 * (s - t) * u + y(), i + y(), s + y()] }), p;
}
function ls(e, t, i) {
  const s = [];
  s.push([e[0][0] + b(t, i), e[0][1] + b(t, i)]), s.push([e[0][0] + b(t, i), e[0][1] + b(t, i)]);
  for (let n = 1; n < e.length; n++)
    s.push([e[n][0] + b(t, i), e[n][1] + b(t, i)]), n === e.length - 1 && s.push([e[n][0] + b(t, i), e[n][1] + b(t, i)]);
  return ue(s, null, i);
}
function ue(e, t, i) {
  const s = e.length;
  let n = [];
  if (s > 3) {
    const r = [], a = 1 - i.curveTightness;
    n.push({ op: "move", data: [e[1][0], e[1][1]] });
    for (let h = 1; h + 2 < s; h++) {
      const l = e[h];
      r[0] = [l[0], l[1]], r[1] = [l[0] + (a * e[h + 1][0] - a * e[h - 1][0]) / 6, l[1] + (a * e[h + 1][1] - a * e[h - 1][1]) / 6], r[2] = [e[h + 1][0] + (a * e[h][0] - a * e[h + 2][0]) / 6, e[h + 1][1] + (a * e[h][1] - a * e[h + 2][1]) / 6], r[3] = [e[h + 1][0], e[h + 1][1]], n.push({ op: "bcurveTo", data: [r[1][0], r[1][1], r[2][0], r[2][1], r[3][0], r[3][1]] });
    }
    if (t && t.length === 2) {
      const h = i.maxRandomnessOffset;
      n.push({ op: "lineTo", data: [t[0] + b(h, i), t[1] + b(h, i)] });
    }
  } else
    s === 3 ? (n.push({ op: "move", data: [e[1][0], e[1][1]] }), n.push({ op: "bcurveTo", data: [e[1][0], e[1][1], e[2][0], e[2][1], e[2][0], e[2][1]] })) : s === 2 && (n = n.concat(J(e[0][0], e[0][1], e[1][0], e[1][1], i)));
  return n;
}
function cs(e, t, i, s, n, r, a, h) {
  const l = [], o = [], c = b(0.5, h) - Math.PI / 2;
  o.push([b(r, h) + t + 0.9 * s * Math.cos(c - e), b(r, h) + i + 0.9 * n * Math.sin(c - e)]);
  for (let u = c; u < 2 * Math.PI + c - 0.01; u += e) {
    const d = [b(r, h) + t + s * Math.cos(u), b(r, h) + i + n * Math.sin(u)];
    l.push(d), o.push(d);
  }
  return o.push([b(r, h) + t + s * Math.cos(c + 2 * Math.PI + 0.5 * a), b(r, h) + i + n * Math.sin(c + 2 * Math.PI + 0.5 * a)]), o.push([b(r, h) + t + 0.98 * s * Math.cos(c + a), b(r, h) + i + 0.98 * n * Math.sin(c + a)]), o.push([b(r, h) + t + 0.9 * s * Math.cos(c + 0.5 * a), b(r, h) + i + 0.9 * n * Math.sin(c + 0.5 * a)]), [o, l];
}
function us(e, t, i, s, n, r, a, h, l) {
  const o = r + b(0.1, l), c = [];
  c.push([b(h, l) + t + 0.9 * s * Math.cos(o - e), b(h, l) + i + 0.9 * n * Math.sin(o - e)]);
  for (let u = o; u <= a; u += e)
    c.push([b(h, l) + t + s * Math.cos(u), b(h, l) + i + n * Math.sin(u)]);
  return c.push([t + s * Math.cos(a), i + n * Math.sin(a)]), c.push([t + s * Math.cos(a), i + n * Math.sin(a)]), ue(c, null, l);
}
function Le(e, t, i, s, n, r, a, h) {
  const l = [], o = [h.maxRandomnessOffset || 1, (h.maxRandomnessOffset || 1) + 0.5];
  let c = [0, 0];
  for (let u = 0; u < 2; u++)
    u === 0 ? l.push({ op: "move", data: [a.x, a.y] }) : l.push({ op: "move", data: [a.x + b(o[0], h), a.y + b(o[0], h)] }), c = [n + b(o[u], h), r + b(o[u], h)], l.push({ op: "bcurveTo", data: [e + b(o[u], h), t + b(o[u], h), i + b(o[u], h), s + b(o[u], h), c[0], c[1]] });
  return a.setPosition(c[0], c[1]), l;
}
function Xh(e, t, i, s) {
  let n = [];
  switch (t.key) {
    ...
    case "m": {
      const r = t.key === "m";
      if (t.data.length >= 2) {
        let a = +t.data[0], h = +t.data[1];
        r && (a += e.x, h += e.y);
        const l = 1 * (s.maxRandomnessOffset || 0);
        a += b(l, s), h += b(l, s), e.setPosition(a, h), n.push({ op: "move", data: [a, h] });
      }
      break;
    }
    case "L":
    case "l": {
      ...
      if (t.data.length >= 2) {
        let a = +t.data[0], h = +t.data[1];
        r && (a += e.x, h += e.y), n = n.concat(J(e.x, e.y, a, h, s)), e.setPosition(a, h);
      }
      break;
    }
    case "H":
    case "h": {
      ...
      if (t.data.length) {
        let a = +t.data[0];
        r && (a += e.x), n = n.concat(J(e.x, e.y, a, e.y, s)), e.setPosition(a, e.y);
      }
      break;
    }
    case "V":
    case "v": {
      ...
      if (t.data.length) {
        let a = +t.data[0];
        r && (a += e.y), n = n.concat(J(e.x, e.y, e.x, a, s)), e.setPosition(e.x, a);
      }
      break;
    }
    case "Z":
    case "z":
      e.first && (n = n.concat(J(e.x, e.y, e.first[0], e.first[1], s)), e.setPosition(e.first[0], e.first[1]), e.first = null);
      break;
    case "C":
    case "c": {
      const r = t.key === "c";
      if (t.data.length >= 6) {
        let a = +t.data[0], h = +t.data[1], l = +t.data[2], o = +t.data[3], c = +t.data[4], u = +t.data[5];
        r && (a += e.x, l += e.x, c += e.x, h += e.y, o += e.y, u += e.y);
        const d = Le(a, h, l, o, c, u, e, s);
        n = n.concat(d), e.bezierReflectionPoint = [c + (c - l), u + (u - o)];
      }
      break;
    }
    case "S":
    case "s": {
      const r = t.key === "s";
      if (t.data.length >= 4) {
        let a = +t.data[0], h = +t.data[1], l = +t.data[2], o = +t.data[3];
        r && (a += e.x, l += e.x, h += e.y, o += e.y);
        let c = a, u = h;
        const d = i ? i.key : "";
        let f = null;
        d !== "c" && d !== "C" && d !== "s" && d !== "S" || (f = e.bezierReflectionPoint), f && (c = f[0], u = f[1]);
        const p = Le(c, u, a, h, l, o, e, s);
        n = n.concat(p), e.bezierReflectionPoint = [l + (l - a), o + (o - h)];
      }
      break;
    }
    case "Q":
    case "q": {
      ...
      if (t.data.length >= 4) {
        ...
        n.push({ op: "move", data: [e.x + b(c, s), e.y + b(c, s)] });
        let d = [l + b(c, s), o + b(c, s)];
        n.push({ op: "qcurveTo", data: [a + b(c, s), h + b(c, s), d[0], d[1]] }), n.push({ op: "move", data: [e.x + b(u, s), e.y + b(u, s)] }), d = [l + b(u, s), o + b(u, s)], n.push({ op: "qcurveTo", data: [a + b(u, s), h + b(u, s), d[0], d[1]] }), e.setPosition(d[0], d[1]), e.quadReflectionPoint = [l + (l - a), o + (o - h)];
      }
      break;
    }
    case "T":
    case "t": {
      ...
      if (t.data.length >= 2) {
        ...
        const c = i ? i.key : "";
        let u = null;
        c !== "q" && c !== "Q" && c !== "t" && c !== "T" || (u = e.quadReflectionPoint), u && (l = u[0], o = u[1]);
        const d = 1 * (1 + 0.2 * s.roughness), f = 1.5 * (1 + 0.22 * s.roughness);
        n.push({ op: "move", data: [e.x + b(d, s), e.y + b(d, s)] });
        let p = [a + b(d, s), h + b(d, s)];
        n.push({ op: "qcurveTo", data: [l + b(d, s), o + b(d, s), p[0], p[1]] }), n.push({ op: "move", data: [e.x + b(f, s), e.y + b(f, s)] }), p = [a + b(f, s), h + b(f, s)], n.push({ op: "qcurveTo", data: [l + b(f, s), o + b(f, s), p[0], p[1]] }), e.setPosition(p[0], p[1]), e.quadReflectionPoint = [a + (a - l), h + (h - o)];
      }
      break;
    }
    case "A":
    case "a": {
      const r = t.key === "a";
      if (t.data.length >= 7) {
        const a = +t.data[0], h = +t.data[1], l = +t.data[2], o = +t.data[3], c = +t.data[4];
        let u = +t.data[5], d = +t.data[6];
        if (r && (u += e.x, d += e.y), u === e.x && d === e.y)
          break;
        if (a === 0 || h === 0)
          n = n.concat(J(e.x, e.y, u, d, s)), e.setPosition(u, d);
        else
          for (let f = 0; f < 1; f++) {
            const p = new Lh([e.x, e.y], [u, d], [a, h], l, !!o, !!c);
            let g = p.getNextSegment();
            for (; g; ) {
              const y = Le(g.cp1[0], g.cp1[1], g.cp2[0], g.cp2[1], g.to[0], g.to[1], e, s);
              n = n.concat(y), g = p.getNextSegment();
            }
          }
      }
      break;
...
const Kh = typeof self < "u", U = "none";
class Qh {
  constructor(t, i) {
    this.defaultOptions = { maxRandomnessOffset: 2, roughness: 1, bowing: 1, stroke: "#000", strokeWidth: 1, curveTightness: 0, curveFitting: 0.95, curveStepCount: 9, fillStyle: "hachure", fillWeight: -1, hachureAngle: -41, hachureGap: -1, dashOffset: -1, dashGap: -1, zigzagOffset: -1, seed: 0, roughnessGain: 1 }, this.config = t || {}, this.surface = i, this.config.options && (this.defaultOptions = this._options(this.config.options));
  }
  static newSeed() {
  ...
  _drawable(t, i, s) {
    return { shape: t, sets: i || [], options: s || this.defaultOptions };
  }
  line(t, i, s, n, r) {
    const a = this._options(r);
    return this._drawable("line", [Us(t, i, s, n, a)], a);
  }
  rectangle(t, i, s, n, r) {
    const a = this._options(r), h = [], l = function(o, c, u, d, f) {
      return function(p, g) {
        return Ie(p, !0, g);
      }([[o, c], [o + u, c], [o + u, c + d], [o, c + d]], f);
    }(t, i, s, n, a);
    if (a.fill) {
      const o = [[t, i], [t + s, i], [t + s, i + n], [t, i + n]];
      a.fillStyle === "solid" ? h.push(as(o, a)) : h.push(It(o, a));
    }
    return a.stroke !== U && h.push(l), this._drawable("rectangle", h, a);
  }
  ellipse(t, i, s, n, r) {
    const a = this._options(r), h = [], l = Js(s, n, a), o = si(t, i, a, l);
    if (a.fill)
      if (a.fillStyle === "solid") {
        const c = si(t, i, a, l).opset;
        c.type = "fillPath", h.push(c);
      } else
        h.push(It(o.estimatedPoints, a));
    return a.stroke !== U && h.push(o.opset), this._drawable("ellipse", h, a);
  }
  circle(t, i, s, n) {
    const r = this.ellipse(t, i, s, s, n);
    return r.shape = "circle", r;
  }
  linearPath(t, i) {
    const s = this._options(i);
    return this._drawable("linearPath", [Ie(t, !1, s)], s);
  }
  arc(t, i, s, n, r, a, h = !1, l) {
    const o = this._options(l), c = [], u = rs(t, i, s, n, r, a, h, !0, o);
    if (h && o.fill)
      if (o.fillStyle === "solid") {
        const d = rs(t, i, s, n, r, a, !0, !1, o);
        d.type = "fillPath", c.push(d);
      } else
        c.push(function(d, f, p, g, y, m, x) {
          const k = d, S = f;
          let R = Math.abs(p / 2), v = Math.abs(g / 2);
          R += b(0.01 * R, x), v += b(0.01 * v, x);
          let M = y, F = m;
          for (; M < 0; )
            M += 2 * Math.PI, F += 2 * Math.PI;
          F - M > 2 * Math.PI && (M = 0, F = 2 * Math.PI);
          const E = (F - M) / x.curveStepCount, W = [];
          for (let z = M; z <= F; z += E)
            W.push([k + R * Math.cos(z), S + v * Math.sin(z)]);
          return W.push([k + R * Math.cos(F), S + v * Math.sin(F)]), W.push([k, S]), It(W, x);
        }(t, i, s, n, r, a, o));
    return o.stroke !== U && c.push(u), this._drawable("arc", c, o);
  }
  curve(t, i) {
    const s = this._options(i);
    return this._drawable("curve", [Hh(t, s)], s);
  }
  polygon(t, i) {
    const s = this._options(i), n = [], r = Ie(t, !0, s);
    return s.fill && (s.fillStyle === "solid" ? n.push(as(t, s)) : n.push(It(t, s))), s.stroke !== U && n.push(r), this._drawable("polygon", n, s);
  }
  path(t, i) {
    ...
    const r = function(a, h) {
      ...
      let l = new hs(a);
      if (h.simplification) {
        const u = new Bh(l.linearPoints, l.closed).fit(h.simplification);
        l = new hs(u);
      }
      let o = [];
      const c = l.segments || [];
      for (let u = 0; u < c.length; u++) {
        const d = Xh(l, c[u], u > 0 ? c[u - 1] : null, h);
        d && d.length && (o = o.concat(d));
      }
      return { type: "path", ops: o };
    }(t, s);
    if (s.fill)
      if (s.fillStyle === "solid") {
        const a = { type: "path2Dfill", path: t, ops: [] };
        n.push(a);
      } else {
        const a = this.computePathSize(t), h = It([[0, 0], [a[0], 0], [a[0], a[1]], [0, a[1]]], s);
        h.type = "path2Dpattern", h.size = a, h.path = t, n.push(h);
      }
    return s.stroke !== U && n.push(r), this._drawable("path", n, s);
  }
  computePathSize(t) {
    let i = [0, 0];
    if (Kh && self.document)
      try {
        const n = self.document.createElementNS(st, "svg");
        n.setAttribute("width", "0"), n.setAttribute("height", "0");
        const r = self.document.createElementNS(st, "path");
        r.setAttribute("d", t), n.appendChild(r), self.document.body.appendChild(n);
        const a = r.getBBox();
        a && (i[0] = a.width || 0, i[1] = a.height || 0), self.document.body.removeChild(n);
      } catch {
      }
  ...
  getCanvasSize() {
    const t = (i) => i && typeof i == "object" && i.baseVal && i.baseVal.value ? i.baseVal.value : i || 100;
  ...
  toPaths(t) {
    const i = t.sets || [], s = t.options || this.defaultOptions, n = [];
    for (const r of i) {
      let a = null;
      switch (r.type) {
        case "path":
          a = { d: this.opsToPath(r), stroke: s.stroke, strokeWidth: s.strokeWidth, fill: U };
          break;
        case "fillPath":
          a = { d: this.opsToPath(r), stroke: U, strokeWidth: 0, fill: s.fill || U };
          break;
        case "fillSketch":
          a = this.fillSketch(r, s);
          break;
        case "path2Dfill":
          a = { d: r.path || "", stroke: U, strokeWidth: 0, fill: s.fill || U };
          break;
        case "path2Dpattern": {
          const h = r.size, l = { x: 0, y: 0, width: 1, height: 1, viewBox: `0 0 ${Math.round(h[0])} ${Math.round(h[1])}`, patternUnits: "objectBoundingBox", path: this.fillSketch(r, s) };
          a = { d: r.path, stroke: U, strokeWidth: 0, pattern: l };
          break;
        }
      }
      a && n.push(a);
  ...
  fillSketch(t, i) {
    let s = i.fillWeight;
    return s < 0 && (s = i.strokeWidth / 2), { d: this.opsToPath(t), stroke: i.fill || U, strokeWidth: s, fill: U };
  }
}
const Uh = typeof document < "u";
class Jh {
  constructor(t, i) {
    this.svg = t, this.gen = new Qh(i, this.svg);
  }
  get defs() {
    const t = this.svg.ownerDocument || Uh && document;
    if (t && !this._defs) {
      const i = t.createElementNS(st, "defs");
  ...
  draw(t) {
    const i = t.sets || [], s = t.options || this.getDefaultOptions(), n = this.svg.ownerDocument || window.document, r = n.createElementNS(st, "g");
    for (const a of i) {
      let h = null;
      switch (a.type) {
        case "path":
          h = n.createElementNS(st, "path"), h.setAttribute("d", this.opsToPath(a)), h.style.stroke = s.stroke, h.style.strokeWidth = s.strokeWidth + "", h.style.fill = "none";
          break;
        case "fillPath":
          h = n.createElementNS(st, "path"), h.setAttribute("d", this.opsToPath(a)), h.style.stroke = "none", h.style.strokeWidth = "0", h.style.fill = s.fill || "";
          break;
        case "fillSketch":
          h = this.fillSketch(n, a, s);
          break;
        case "path2Dfill":
          h = n.createElementNS(st, "path"), h.setAttribute("d", a.path || ""), h.style.stroke = "none", h.style.strokeWidth = "0", h.style.fill = s.fill || "";
          break;
        case "path2Dpattern":
          if (this.defs) {
            const l = a.size, o = n.createElementNS(st, "pattern"), c = `rough-${Math.floor(Math.random() * (Number.MAX_SAFE_INTEGER || 999999))}`;
            o.setAttribute("id", c), o.setAttribute("x", "0"), o.setAttribute("y", "0"), o.setAttribute("width", "1"), o.setAttribute("height", "1"), o.setAttribute("height", "1"), o.setAttribute("viewBox", `0 0 ${Math.round(l[0])} ${Math.round(l[1])}`), o.setAttribute("patternUnits", "objectBoundingBox");
            const u = this.fillSketch(n, a, s);
            o.appendChild(u), this.defs.appendChild(o), h = n.createElementNS(st, "path"), h.setAttribute("d", a.path || ""), h.style.stroke = "none", h.style.strokeWidth = "0", h.style.fill = `url(#${c})`;
          } else
  ...
  fillSketch(t, i, s) {
    ...
    const r = t.createElementNS(st, "path");
    return r.setAttribute("d", this.opsToPath(i)), r.style.stroke = s.fill || "", r.style.strokeWidth = n + "", r.style.fill = "none", r;
  }
  get generator() {
    return this.gen;
  }
  ...
  line(t, i, s, n, r) {
    const a = this.gen.line(t, i, s, n, r);
    return this.draw(a);
  }
  rectangle(t, i, s, n, r) {
    const a = this.gen.rectangle(t, i, s, n, r);
    return this.draw(a);
  }
  ellipse(t, i, s, n, r) {
    const a = this.gen.ellipse(t, i, s, n, r);
    return this.draw(a);
  }
  circle(t, i, s, n) {
    const r = this.gen.circle(t, i, s, n);
    return this.draw(r);
  }
  linearPath(t, i) {
    const s = this.gen.linearPath(t, i);
    return this.draw(s);
  }
  polygon(t, i) {
    const s = this.gen.polygon(t, i);
    return this.draw(s);
  }
  arc(t, i, s, n, r, a, h = !1, l) {
    const o = this.gen.arc(t, i, s, n, r, a, h, l);
    return this.draw(o);
  }
  curve(t, i) {
    const s = this.gen.curve(t, i);
    return this.draw(s);
  }
  path(t, i) {
    const s = this.gen.path(t, i);
    return this.draw(s);
  }
}
var B = (e, t) => new Jh(e, t);
class ct {
  constructor(t) {
...
const at = ({ roughness: e, ceiling: t = 20, defaultValue: i = 1 }) => e === void 0 || typeof e != "number" ? i : e > t ? t : e;
class kr extends ct {
  constructor(t) {
  ...
  initChartValues(t) {
    ...
    const i = A(this.el).node().getBoundingClientRect(), s = i.width, n = i.height;
  ...
  addScales() {
    const t = this;
    this.xScale = Qt().rangeRound([0, this.width]).padding(this.padding).domain(this.dataFormat === "file" ? this.data.map((i) => i[t.labels]) : this.data[t.labels]), this.yScale = O().rangeRound([this.height, 0]).domain(this.dataFormat === "file" ? [0, D(this.data, (i) => +i[t.values])] : [0, D(this.data[t.values])]);
  }
  addLabels() {
  ...
  addAxes() {
    const t = Xt(this.xScale).tickSize(0).tickFormat((s) => this.xValueFormat ? rt(this.xValueFormat)(s) : s), i = Kt(this.yScale).tickSize(0).tickFormat((s) => this.yValueFormat ? rt(this.yValueFormat)(s) : s);
    this.svg.append("g").attr("transform", "translate(0," + this.height + ")").call(t).attr("class", `xAxis${this.graphClass}`).selectAll("text").attr("transform", "translate(-10,0)rotate(-45)").style("text-anchor", "end").style("font-family", this.fontFamily).style("font-size", this.axisFontSize === void 0 ? `${Math.min(0.8, Math.min(this.width, this.height) / 140)}rem` : this.axisFontSize).style("opacity", 0.9), this.svg.append("g").call(i).attr("class", `yAxis${this.graphClass}`).selectAll("text").style("font-family", this.fontFamily).style("font-size", this.axisFontSize === void 0 ? `${Math.min(0.95, Math.min(this.width, this.height) / 140)}rem` : this.axisFontSize).style("opacity", 0.9), P("path.domain").attr("stroke", "transparent");
  }
  makeAxesRough(t, i) {
    const s = `xAxis${this.graphClass}`, n = `yAxis${this.graphClass}`, r = `rough-${s}`, a = `rough-${n}`;
    A(`.${s}`).selectAll("path.domain").each(function(h, l) {
      const o = A(this).node().getAttribute("d"), c = i.path(o, { fillStyle: "hachure" });
      c.setAttribute("class", r), t.appendChild(c);
    }), P(`.${r}`).attr("transform", `translate(0, ${this.height})`), A(`.${n}`).selectAll("path.domain").each(function(h, l) {
      const o = A(this).node().getAttribute("d"), c = i.path(o, { fillStyle: "hachure" });
      c.setAttribute("class", a), t.appendChild(c);
    });
  }
  setTitle(t) {
  ...
  addInteraction() {
    ...
    P(this.interactionG).on("mouseover", function() {
      t.style("opacity", 1), A(this).select("path").style("stroke", i.highlight), A(this).selectAll("path:nth-child(2)").style("stroke-width", i.strokeWidth + 1.2);
    }), P(this.interactionG).on("mouseout", function() {
      t.style("opacity", 0), A(this).select("path").style("stroke", i.color), A(this).selectAll("path:nth-child(2)").style("stroke-width", i.strokeWidth);
    }), P(this.interactionG).on("mousemove", function(s) {
      const n = A(this).attr("attrX"), r = A(this).attr("attrY"), a = wt(this);
      t.html(`<b>${n}</b>: ${r}`).style("opacity", 0.95).style("transform", `translate(${a[0] + 10 + i.margin.left}px, 
              ${a[1] - 10 - (i.height + i.margin.top + i.margin.bottom / 2)}px)`);
    });
  }
  initRoughObjects() {
    this.roughSvg = document.getElementById(this.roughId), this.rcAxis = B(this.roughSvg, { options: { strokeWidth: this.axisStrokeWidth, roughness: this.axisRoughness } }), this.rc = B(this.roughSvg, { options: { fill: this.color, stroke: this.stroke === "none" ? void 0 : this.stroke, strokeWidth: this.innerStrokeWidth, roughness: this.roughness, bowing: this.bowing, fillStyle: this.fillStyle } });
  }
  drawFromObject() {
    this.initRoughObjects(), this.addScales(), this.addAxes(), this.makeAxesRough(this.roughSvg, this.rcAxis), this.addLabels(), this.data.values.forEach((t, i) => {
      const s = this.rc.rectangle(this.xScale(this.data[this.labels][i]), this.yScale(+t), this.xScale.bandwidth(), this.height - this.yScale(+t), { simplification: this.simplification, fillWeight: this.fillWeight }), n = this.roughSvg.appendChild(s);
      n.setAttribute("class", this.graphClass), n.setAttribute("attrX", this.data[this.labels][i]), n.setAttribute("attrY", +t);
  ...
  drawFromFile() {
    this.initRoughObjects(), this.addScales(), this.addAxes(), this.makeAxesRough(this.roughSvg, this.rcAxis), this.addLabels(), this.data.forEach((t) => {
      const i = this.rc.rectangle(this.xScale(t[this.labels]), this.yScale(+t[this.values]), this.xScale.bandwidth(), this.height - this.yScale(+t[this.values]), { simplification: this.simplification, fillWeight: this.fillWeight }), s = this.roughSvg.appendChild(i);
...
class wr extends ct {
  ...
  addScales() {
    const t = this;
    this.yScale = Qt().rangeRound([0, this.height]).padding(this.padding).domain(this.dataFormat === "file" ? this.data.map((i) => i[t.labels]) : this.data[t.labels]), this.xScale = O().rangeRound([0, this.width]).domain(this.dataFormat === "file" ? [0, D(this.data, (i) => +i[t.values])] : [0, D(this.data[t.values])]);
  }
  addLabels() {
  ...
  addInteraction() {
    ...
    P(this.interactionG).on("mouseover", function() {
      ...
      const n = A(this).attr("attrX"), r = A(this).attr("attrY"), a = wt(this);
      t.html(`<b>${n}</b>: ${r}`).style("opacity", 0.95).style("transform", `translate(${a[0] + i.margin.left}px, 
              ${a[1] - (i.height + i.margin.top + i.margin.bottom / 2)}px)`);
    });
  }
  initRoughObjects() {
    this.roughSvg = document.getElementById(this.roughId), this.rcAxis = B(this.roughSvg, { options: { strokeWidth: this.axisStrokeWidth, roughness: this.axisRoughness } }), this.rc = B(this.roughSvg, { options: { fill: this.color, stroke: this.stroke === "none" ? void 0 : this.stroke, strokeWidth: this.innerStrokeWidth, roughness: this.roughness, bowing: this.bowing, fillStyle: this.fillStyle } });
  ...
  drawFromObject() {
    this.initRoughObjects(), this.addScales(), this.addAxes(), this.makeAxesRough(this.roughSvg, this.rcAxis), this.addLabels(), this.data.values.forEach((t, i) => {
      const s = this.rc.rectangle(0, this.yScale(this.data[this.labels][i]), this.xScale(t), this.yScale.bandwidth(), { simplification: this.simplification, fillWeight: this.fillWeight }), n = this.roughSvg.appendChild(s);
      n.setAttribute("class", this.graphClass), n.setAttribute("attrX", this.data[this.labels][i]), n.setAttribute("attrY", +t);
    }), P(this.interactionG).selectAll("path:nth-child(2)").style("stroke-width", this.strokeWidth), this.interactive === !0 && this.addInteraction();
  }
  drawFromFile() {
    this.initRoughObjects(), this.addScales(), this.addAxes(), this.makeAxesRough(this.roughSvg, this.rcAxis), this.addLabels(), this.data.forEach((t) => {
      const i = this.rc.rectangle(0, this.yScale(t[this.labels]), this.xScale(+t[this.values]), this.yScale.bandwidth(), { simplification: this.simplification, fillWeight: this.fillWeight }), s = this.roughSvg.appendChild(i);
      s.setAttribute("class", this.graphClass), s.setAttribute("attrX", t[this.labels]), s.setAttribute("attrY", +t[this.values]);
    }), P(this.interactionG).selectAll("path:nth-child(2)").style("stroke-width", this.strokeWidth), this.interactive === !0 && this.addInteraction();
  }
}
var ni = Math.PI, hi = 2 * ni, mt = 1e-6, _h = hi - mt;
function ri() {
...
ri.prototype = mi.prototype = { constructor: ri, moveTo: function(e, t) {
  this._ += "M" + (this._x0 = this._x1 = +e) + "," + (this._y0 = this._y1 = +t);
}, closePath: function() {
  this._x1 !== null && (this._x1 = this._x0, this._y1 = this._y0, this._ += "Z");
}, lineTo: function(e, t) {
  this._ += "L" + (this._x1 = +e) + "," + (this._y1 = +t);
}, quadraticCurveTo: function(e, t, i, s) {
  this._ += "Q" + +e + "," + +t + "," + (this._x1 = +i) + "," + (this._y1 = +s);
}, bezierCurveTo: function(e, t, i, s, n, r) {
  this._ += "C" + +e + "," + +t + "," + +i + "," + +s + "," + (this._x1 = +n) + "," + (this._y1 = +r);
}, arcTo: function(e, t, i, s, n) {
  e = +e, t = +t, i = +i, s = +s, n = +n;
  var r = this._x1, a = this._y1, h = i - e, l = s - t, o = r - e, c = a - t, u = o * o + c * c;
  if (n < 0)
    throw new Error("negative radius: " + n);
  if (this._x1 === null)
    this._ += "M" + (this._x1 = e) + "," + (this._y1 = t);
  else if (u > mt)
    if (Math.abs(c * h - l * o) > mt && n) {
      var d = i - r, f = s - a, p = h * h + l * l, g = d * d + f * f, y = Math.sqrt(p), m = Math.sqrt(u), x = n * Math.tan((ni - Math.acos((p + u - g) / (2 * y * m))) / 2), k = x / m, S = x / y;
      Math.abs(k - 1) > mt && (this._ += "L" + (e + k * o) + "," + (t + k * c)), this._ += "A" + n + "," + n + ",0,0," + +(c * d > o * f) + "," + (this._x1 = e + S * h) + "," + (this._y1 = t + S * l);
    } else
      this._ += "L" + (this._x1 = e) + "," + (this._y1 = t);
}, arc: function(e, t, i, s, n, r) {
  e = +e, t = +t, r = !!r;
  var a = (i = +i) * Math.cos(s), h = i * Math.sin(s), l = e + a, o = t + h, c = 1 ^ r, u = r ? s - n : n - s;
  if (i < 0)
    throw new Error("negative radius: " + i);
  this._x1 === null ? this._ += "M" + l + "," + o : (Math.abs(this._x1 - l) > mt || Math.abs(this._y1 - o) > mt) && (this._ += "L" + l + "," + o), i && (u < 0 && (u = u % hi + hi), u > _h ? this._ += "A" + i + "," + i + ",0,1," + c + "," + (e - a) + "," + (t - h) + "A" + i + "," + i + ",0,1," + c + "," + (this._x1 = l) + "," + (this._y1 = o) : u > mt && (this._ += "A" + i + "," + i + ",0," + +(u >= ni) + "," + c + "," + (this._x1 = e + i * Math.cos(n)) + "," + (this._y1 = t + i * Math.sin(n))));
}, rect: function(e, t, i, s) {
  this._ += "M" + (this._x0 = this._x1 = +e) + "," + (this._y0 = this._y1 = +t) + "h" + +i + "v" + +s + "h" + -i + "Z";
}, toString: function() {
  return this._;
} };
var ds = Math.abs, N = Math.atan2, pt = Math.cos, $h = Math.max, Be = Math.min, it = Math.sin, Rt = Math.sqrt, Y = 1e-12, Nt = Math.PI, de = Nt / 2, se = 2 * Nt;
function fs(e) {
...
function _t(e, t, i, s, n, r, a) {
  var h = e - i, l = t - s, o = (a ? r : -r) / Rt(h * h + l * l), c = o * l, u = -o * h, d = e + c, f = t + u, p = i + c, g = s + u, y = (d + p) / 2, m = (f + g) / 2, x = p - d, k = g - f, S = x * x + k * k, R = n - r, v = d * g - p * f, M = (k < 0 ? -1 : 1) * Rt($h(0, R * R * S - v * v)), F = (v * k - x * M) / S, E = (-v * x - k * M) / S, W = (v * k + x * M) / S, z = (-v * x + k * M) / S, w = F - y, j = E - m, H = W - y, Z = z - m;
  return w * w + j * j > H * H + Z * Z && (F = W, E = z), { cx: F, cy: E, x01: -c, y01: -u, x11: F * (n / R - 1), y11: E * (n / R - 1) };
}
function fe() {
  var e = tr, t = er, i = L(0), s = null, n = ir, r = sr, a = nr, h = null;
  function l() {
    var o, c, u = +e.apply(this, arguments), d = +t.apply(this, arguments), f = n.apply(this, arguments) - de, p = r.apply(this, arguments) - de, g = ds(p - f), y = p > f;
    if (h || (h = o = mi()), d < u && (c = d, d = u, u = c), d > Y)
      if (g > se - Y)
        h.moveTo(d * pt(f), d * it(f)), h.arc(0, 0, d, f, p, !y), u > Y && (h.moveTo(u * pt(p), u * it(p)), h.arc(0, 0, u, p, f, y));
      else {
        var m, x, k = f, S = p, R = f, v = p, M = g, F = g, E = a.apply(this, arguments) / 2, W = E > Y && (s ? +s.apply(this, arguments) : Rt(u * u + d * d)), z = Be(ds(d - u) / 2, +i.apply(this, arguments)), w = z, j = z;
        if (W > Y) {
          var H = fs(W / u * it(E)), Z = fs(W / d * it(E));
          (M -= 2 * H) > Y ? (R += H *= y ? 1 : -1, v -= H) : (M = 0, R = v = (f + p) / 2), (F -= 2 * Z) > Y ? (k += Z *= y ? 1 : -1, S -= Z) : (F = 0, k = S = (f + p) / 2);
        }
        var C = d * pt(k), G = d * it(k), ot = u * pt(v), lt = u * it(v);
        if (z > Y) {
          var I, _ = d * pt(S), ut = d * it(S), Ct = u * pt(R), $ = u * it(R);
          if (g < Nt && (I = function(gt, Me, cn, un, vi, bi, dn, fn) {
            var ki = cn - gt, wi = un - Me, Si = dn - vi, Mi = fn - bi, Ot = Mi * ki - Si * wi;
            if (!(Ot * Ot < Y))
              return [gt + (Ot = (Si * (Me - bi) - Mi * (gt - vi)) / Ot) * ki, Me + Ot * wi];
          }(C, G, Ct, $, _, ut, ot, lt))) {
            var tt = C - I[0], ke = G - I[1], we = _ - I[0], Se = ut - I[1], Ai = 1 / it(function(gt) {
              return gt > 1 ? 0 : gt < -1 ? Nt : Math.acos(gt);
            }((tt * we + ke * Se) / (Rt(tt * tt + ke * ke) * Rt(we * we + Se * Se))) / 2), xi = Rt(I[0] * I[0] + I[1] * I[1]);
            w = Be(z, (u - xi) / (Ai - 1)), j = Be(z, (d - xi) / (Ai + 1));
          }
        }
        F > Y ? j > Y ? (m = _t(Ct, $, C, G, d, j, y), x = _t(_, ut, ot, lt, d, j, y), h.moveTo(m.cx + m.x01, m.cy + m.y01), j < z ? h.arc(m.cx, m.cy, j, N(m.y01, m.x01), N(x.y01, x.x01), !y) : (h.arc(m.cx, m.cy, j, N(m.y01, m.x01), N(m.y11, m.x11), !y), h.arc(0, 0, d, N(m.cy + m.y11, m.cx + m.x11), N(x.cy + x.y11, x.cx + x.x11), !y), h.arc(x.cx, x.cy, j, N(x.y11, x.x11), N(x.y01, x.x01), !y))) : (h.moveTo(C, G), h.arc(0, 0, d, k, S, !y)) : h.moveTo(C, G), u > Y && M > Y ? w > Y ? (m = _t(ot, lt, _, ut, u, -w, y), x = _t(C, G, Ct, $, u, -w, y), h.lineTo(m.cx + m.x01, m.cy + m.y01), w < z ? h.arc(m.cx, m.cy, w, N(m.y01, m.x01), N(x.y01, x.x01), !y) : (h.arc(m.cx, m.cy, w, N(m.y01, m.x01), N(m.y11, m.x11), !y), h.arc(0, 0, u, N(m.cy + m.y11, m.cx + m.x11), N(x.cy + x.y11, x.cx + x.x11), y), h.arc(x.cx, x.cy, w, N(x.y11, x.x11), N(x.y01, x.x01), !y))) : h.arc(0, 0, u, v, R, y) : h.lineTo(ot, lt);
      }
    else
      h.moveTo(0, 0);
    if (h.closePath(), o)
      return h = null, o + "" || null;
  }
  return l.centroid = function() {
    var o = (+e.apply(this, arguments) + +t.apply(this, arguments)) / 2, c = (+n.apply(this, arguments) + +r.apply(this, arguments)) / 2 - Nt / 2;
    return [pt(c) * o, it(c) * o];
  }, l.innerRadius = function(o) {
    return arguments.length ? (e = typeof o == "function" ? o : L(+o), l) : e;
  }, l.outerRadius = function(o) {
    return arguments.length ? (t = typeof o == "function" ? o : L(+o), l) : t;
  }, l.cornerRadius = function(o) {
    return arguments.length ? (i = typeof o == "function" ? o : L(+o), l) : i;
  }, l.padRadius = function(o) {
    return arguments.length ? (s = o == null ? null : typeof o == "function" ? o : L(+o), l) : s;
  }, l.startAngle = function(o) {
    return arguments.length ? (n = typeof o == "function" ? o : L(+o), l) : n;
  }, l.endAngle = function(o) {
    return arguments.length ? (r = typeof o == "function" ? o : L(+o), l) : r;
  }, l.padAngle = function(o) {
    return arguments.length ? (a = typeof o == "function" ? o : L(+o), l) : a;
  }, l.context = function(o) {
    return arguments.length ? (h = o ?? null, l) : h;
  }, l;
}
function $s(e) {
  this._context = e;
...
function ge() {
  var e = lr, t = or, i = null, s = L(0), n = L(se), r = L(0);
  function a(h) {
    var l, o, c, u, d, f = h.length, p = 0, g = new Array(f), y = new Array(f), m = +s.apply(this, arguments), x = Math.min(se, Math.max(-se, n.apply(this, arguments) - m)), k = Math.min(Math.abs(x) / f, r.apply(this, arguments)), S = k * (x < 0 ? -1 : 1);
    for (l = 0; l < f; ++l)
      (d = y[g[l] = l] = +e(h[l], l, h)) > 0 && (p += d);
    for (t != null ? g.sort(function(R, v) {
      return t(y[R], y[v]);
    }) : i != null && g.sort(function(R, v) {
      return i(h[R], h[v]);
    }), l = 0, c = p ? (x - f * S) / p : 0; l < f; ++l, m = u)
      o = g[l], u = m + ((d = y[o]) > 0 ? d * c : 0) + S, y[o] = { data: h[o], index: l, value: d, startAngle: m, endAngle: u, padAngle: k };
    return y;
  }
  return a.value = function(h) {
    return arguments.length ? (e = typeof h == "function" ? h : L(+h), a) : e;
  }, a.sortValues = function(h) {
    return arguments.length ? (t = h, i = null, a) : t;
  }, a.sort = function(h) {
    return arguments.length ? (i = h, t = null, a) : i;
  }, a.startAngle = function(h) {
    return arguments.length ? (s = typeof h == "function" ? h : L(+h), a) : s;
  }, a.endAngle = function(h) {
    return arguments.length ? (n = typeof h == "function" ? h : L(+h), a) : n;
  }, a.padAngle = function(h) {
    return arguments.length ? (r = typeof h == "function" ? h : L(+h), a) : r;
  }, a;
}
function $t() {
}
...
function ps(e, t) {
  this._basis = new ai(e), this._beta = t;
}
function te(e, t, i) {
...
function Ye(e, t, i) {
  var s = e._x1, n = e._y1, r = e._x2, a = e._y2;
  if (e._l01_a > Y) {
    var h = 2 * e._l01_2a + 3 * e._l01_a * e._l12_a + e._l12_2a, l = 3 * e._l01_a * (e._l01_a + e._l12_a);
    s = (s * h - e._x0 * e._l12_2a + e._x2 * e._l01_2a) / l, n = (n * h - e._y0 * e._l12_2a + e._y2 * e._l01_2a) / l;
  }
  if (e._l23_a > Y) {
    var o = 2 * e._l23_2a + 3 * e._l23_a * e._l12_a + e._l12_2a, c = 3 * e._l23_a * (e._l23_a + e._l12_a);
    r = (r * o + e._x1 * e._l23_2a - t * e._l12_2a) / c, a = (a * o + e._y1 * e._l23_2a - i * e._l12_2a) / c;
  }
  e._context.bezierCurveTo(s, n, r, a, e._x2, e._y2);
}
function ms(e, t) {
...
function vs(e, t, i) {
  var s = e._x1 - e._x0, n = t - e._x1, r = (e._y1 - e._y0) / (s || n < 0 && -0), a = (i - e._y1) / (n || s < 0 && -0), h = (r * n + a * s) / (s + n);
  return (xs(r) + xs(a)) * Math.min(Math.abs(r), Math.abs(a), 0.5 * Math.abs(h)) || 0;
}
function bs(e, t) {
  var i = e._x1 - e._x0;
...
function qe(e, t, i) {
  var s = e._x0, n = e._y0, r = e._x1, a = e._y1, h = (r - s) / 3;
  e._context.bezierCurveTo(s + h, n + h * t, r - h, a - h * i, r, a);
}
function Ve(e) {
  this._context = e;
}
$s.prototype = { areaStart: function() {
...
} }, ps.prototype = { lineStart: function() {
  this._x = [], this._y = [], this._basis.lineStart();
}, lineEnd: function() {
  var e = this._x, t = this._y, i = e.length - 1;
  if (i > 0)
    for (var s, n = e[0], r = t[0], a = e[i] - n, h = t[i] - r, l = -1; ++l <= i; )
      s = l / i, this._basis.point(this._beta * e[l] + (1 - this._beta) * (n + s * a), this._beta * t[l] + (1 - this._beta) * (r + s * h));
  this._x = this._y = null, this._basis.lineEnd();
}, point: function(e, t) {
  this._x.push(+e), this._y.push(+t);
} }, function e(t) {
  function i(s) {
    return t === 1 ? new ai(s) : new ps(s, t);
  }
  return i.beta = function(s) {
    return e(+s);
  }, i;
}(0.85), Te.prototype = { areaStart: function() {
  this._line = 0;
}, areaEnd: function() {
  this._line = NaN;
}, lineStart: function() {
...
}(0), Ze.prototype = { areaStart: $t, areaEnd: $t, lineStart: function() {
...
}(0), Ne.prototype = { areaStart: function() {
  this._line = 0;
}, areaEnd: function() {
  this._line = NaN;
}, lineStart: function() {
...
}(0), ms.prototype = { areaStart: function() {
  this._line = 0;
}, areaEnd: function() {
  this._line = NaN;
}, lineStart: function() {
  ...
  function i(s) {
    return t ? new ms(s, t) : new Te(s, 0);
  }
  return i.alpha = function(s) {
    return e(+s);
  }, i;
}(0.5), ys.prototype = { areaStart: $t, areaEnd: $t, lineStart: function() {
  ...
  function i(s) {
    return t ? new ys(s, t) : new Ze(s, 0);
  }
  return i.alpha = function(s) {
    return e(+s);
  }, i;
}(0.5), As.prototype = { areaStart: function() {
  this._line = 0;
}, areaEnd: function() {
  this._line = NaN;
}, lineStart: function() {
  ...
  function i(s) {
    return t ? new As(s, t) : new Ne(s, 0);
  }
  return i.alpha = function(s) {
    return e(+s);
  }, i;
}(0.5), Ve.prototype = { areaStart: function() {
  this._line = 0;
}, areaEnd: function() {
  this._line = NaN;
}, lineStart: function() {
  ...
  switch (this._point) {
    case 2:
      ...
      break;
    case 3:
      qe(this, this._t0, bs(this, this._t0));
  }
  (this._line || this._line !== 0 && this._point === 1) && this._context.closePath(), this._line = 1 - this._line;
}, point: function(e, t) {
  var i = NaN;
  if (t = +t, (e = +e) !== this._x1 || t !== this._y1) {
    switch (this._point) {
      ...
      case 1:
        ...
        break;
      case 2:
        this._point = 3, qe(this, bs(this, i = vs(this, e, t)), i);
        break;
      default:
        qe(this, this._t0, i = vs(this, e, t));
    }
    this._x0 = this._x1, this._x1 = e, this._y0 = this._y1, this._y1 = t, this._t0 = i;
  }
} }, Object.create(Ve.prototype).point = function(e, t) {
  Ve.prototype.point.call(this, t, e);
};
const vt = ["coral", "skyblue", "#66c2a5", "tan", "#8da0cb", "#e78ac3", "#a6d854", "#ffd92f", "coral", "skyblue", "tan", "orange"], ft = (e, t, i, s, n) => {
  e.svg.append("svg").attr("x", e.legendPosition === "left" ? 5 : e.width - (i + 2)).attr("y", 0);
  const r = n === void 0 ? 5 - e.margin.left : n, a = e.rc.rectangle(e.legendPosition === "left" ? r : e.width + e.margin.right - 2 - i, -e.margin.top / 3, i, s, { fill: "white", fillWeight: 0.1, strokeWidth: 0.75, roughness: 2 }), h = e.roughSvg.appendChild(a), l = "rough" + e.el.substring(1, e.el.length);
  h.setAttribute("class", l), t.forEach((o, c) => {
    const u = A("." + l).append("g").attr("transform", `translate(
        ${e.legendPosition === "left" ? 5 : e.width - (i + 2)},
        0)`);
    u.append("rect").style("fill", e.colors[c]).attr("width", 20).attr("height", 8).attr("x", e.legendPosition === "left" ? r : e.margin.right + 5).attr("y", 6 + 11 * c - e.margin.top / 3), u.append("text").style("font-size", ".8rem").style("font-family", e.fontFamily).attr("x", e.legendPosition === "left" ? r + 25 : e.margin.right + 30).attr("y", 6 + 11 * c + 8 - e.margin.top / 3).text(o.text);
  });
};
class Sr extends ct {
  constructor(t) {
    super(t), this.margin = t.margin || { top: 50, right: 20, bottom: 10, left: 20 }, this.colors = t.colors || vt, this.highlight = t.highlight, this.roughness = at({ roughness: t.roughness, ceiling: 30 }), this.strokeWidth = t.strokeWidth || 0.75, this.innerStrokeWidth = t.innerStrokeWidth || 0.75, this.fillWeight = t.fillWeight || 0.85, this.labels = this.dataFormat === "object" ? "labels" : t.labels, this.values = this.dataFormat === "object" ? "values" : t.values, this.labels !== void 0 && this.values !== void 0 ? (this.legend = t.legend !== !1, this.legendPosition = t.legendPosition || "right", this.responsive = !0, this.boundRedraw = this.redraw.bind(this, t), this.initChartValues(t), this.resolveFont(), this.drawChart = this.resolveData(t.data), this.drawChart(), t.title !== "undefined" && this.setTitle(t.title), window.addEventListener("resize", this.resizeHandler.bind(this))) : console.log(`Error for ${this.el}: Must include labels and values when        instantiating Donut chart. Skipping chart.`);
  }
  resizeHandler() {
    this.responsive && this.boundRedraw();
  }
  ...
  addInteraction() {
    ...
    let s;
    P(this.interactionG).on("mouseover", function() {
      t.style("opacity", 1), s = A(this).selectAll("path").style("stroke"), i.highlight === void 0 ? A(this).selectAll("path").style("opacity", 0.5) : A(this).selectAll("path").style("stroke", i.highlight);
    }), P(this.interactionG).on("mouseout", function() {
      t.style("opacity", 0), A(this).selectAll("path").style("stroke", s), A(this).selectAll("path").style("opacity", 1);
    }), P(this.interactionG).on("mousemove", function(n) {
      const r = A(this).attr("attrX"), a = A(this).attr("attrY"), h = wt(this);
      t.html(`<b>${r}</b>: ${a}`).style("opacity", 0.95).style("transform", `translate(${h[0] + i.margin.left}px, 
              ${h[1] - (i.height + i.margin.top + i.margin.bottom / 2)}px)`);
    });
  }
  initRoughObjects() {
    this.roughSvg = document.getElementById(this.roughId), this.rcAxis = B(this.roughSvg, { options: { strokeWidth: this.strokeWidth >= 3 ? 3 : this.strokeWidth } }), this.rc = B(this.roughSvg, { options: { fill: this.color, strokeWidth: this.innerStrokeWidth, roughness: this.roughness, bowing: this.bowing, fillStyle: this.fillStyle, fillWeight: this.fillWeight } });
  }
  drawFromObject() {
    this.initRoughObjects(), this.makePie = ge(), this.makeArc = fe().innerRadius(0).outerRadius(this.radius), this.arcs = this.makePie(this.data[this.values]), this.arcs.forEach((r, a) => {
      if (r.value !== 0) {
        ...
        const l = this.roughSvg.appendChild(h);
        l.setAttribute("attrY", this.data[this.values][a]), l.setAttribute("attrX", this.data[this.labels][a]);
      }
    });
    ...
    const i = this.data.labels.map((r, a) => ({ color: this.colors[a], text: r })), s = 6 * i.reduce((r, a) => r > a.text.length ? r : a.text.length, 0) + 35, n = 11 * i.length + 8;
    this.legend === !0 && ft(this, i, s, n), this.interactive === !0 && this.addInteraction();
  }
  drawFromFile() {
    this.initRoughObjects(), this.makePie = ge().value((a) => a[this.values]).sort(null);
    const t = [];
    this.makeArc = fe().innerRadius(0).outerRadius(this.radius), this.arcs = this.makePie(this.data), this.arcs.forEach((a, h) => {
      if (a.value !== 0) {
        const l = this.rc.arc(this.width / 2, this.height / 2, 2 * this.radius, 2 * this.radius, a.startAngle - Math.PI / 2, a.endAngle - Math.PI / 2, !0, { fill: this.colors[h], stroke: this.colors[h] });
        l.setAttribute("class", this.graphClass);
        const o = this.roughSvg.appendChild(l);
        o.setAttribute("attrY", a.data[this.values]), o.setAttribute("attrX", a.data[this.labels]);
      }
      t.push(a.data[this.labels]);
    });
    const i = this.rc.circle(this.width / 2, this.height / 2, this.radius, { fill: "white", strokeWidth: 0.05, fillWeight: 10, fillStyle: "solid" });
    this.roughSvg.appendChild(i), P(this.interactionG).selectAll("path:nth-child(2)").style("stroke-width", this.strokeWidth);
    const s = t.map((a, h) => ({ color: this.colors[h], text: a })), n = 6 * s.reduce((a, h) => a > h.text.length ? a : h.text.length, 0) + 35, r = 11 * s.length + 8;
    this.legend === !0 && ft(this, s, n, r), this.interactive === !0 && this.addInteraction();
  }
}
class Mr extends ct {
  constructor(t) {
    super(t), this.margin = t.margin || { top: 50, right: 20, bottom: 50, left: 100 }, this.roughness = at({ roughness: t.roughness, defaultValue: 2.2 }), this.axisStrokeWidth = t.axisStrokeWidth || 0.5, this.axisRoughness = t.axisRoughness || 0.5, this.stroke = t.stroke || "black", this.fillWeight = t.fillWeight || 0.5, this.colors = t.colors, this.strokeWidth = t.strokeWidth || 1, this.axisFontSize = t.axisFontSize, this.x = t.x, this.y = this.dataFormat === "object" ? "y" : t.y, this.xValueFormat = t.xValueFormat, this.yValueFormat = t.yValueFormat, this.legend = t.legend !== !1, this.legendPosition = t.legendPosition || "right", this.circle = t.circle !== !1, this.circleRadius = t.circleRadius || 10, this.circleRoughness = at({ roughness: t.circleRoughness, defaultValue: 2 }), this.xLabel = t.xLabel || "", this.yLabel = t.yLabel || "", this.labelFontSize = t.labelFontSize || "1rem", this.dataFormat === "file" && (this.dataSources = [], this.yKeys = Object.keys(t).filter((i) => /y/.test(i)), this.yKeys.map((i, s) => {
      i !== "yLabel" && this.dataSources.push(t[i]);
  ...
  addScales() {
    ...
    if (this.dataFormat !== "file")
      t = ((r) => {
        const a = Object.keys(r).map((o) => et(r[o])), h = dt(a, (o) => o[0]), l = D(a, (o) => o[1]);
        return [h, l];
      })(this.data);
    else {
      const r = this.dataSources.map((l) => et(this.data, (o) => +o[l])), a = dt(r, (l) => l[0]), h = D(r, (l) => l[1]);
      t = [a, h];
    }
    if (this.x === void 0) {
      const r = D(Object.keys(this.data).map((a) => this.data[a].length));
      i = this.dataFormat === "file" ? [0, this.data.length] : [0, r];
    } else
      i = et(this.x);
    const s = t, n = s[1] - s[0];
    this.xScale = this.x === void 0 ? Li().range([0, this.width]).domain([...Array(i[1]).keys()]) : Li().range([0, this.width]).domain(this.x), this.yScale = O().range([this.height, 0]).domain([0, s[1] + 0.05 * n]);
  }
  addLabels() {
  ...
  addInteraction() {
    const t = this;
    this.chartScreen = this.svg.append("g").attr("pointer-events", "all"), this.dataSources.map((i, s) => {
      const n = (this.dataFormat === "file" ? this.data : this.data[i]).map((l, o) => this.x === void 0 ? [this.xScale(o), this.yScale(l[i])] : [this.xScale(this.x[o]), this.yScale(+l[i])]), r = n.filter((l) => l[0] !== void 0), a = function() {
        var l = rr, o = ar, c = L(!0), u = null, d = hr, f = null;
        function p(g) {
          var y, m, x, k = g.length, S = !1;
          for (u == null && (f = d(x = mi())), y = 0; y <= k; ++y)
            !(y < k && c(m = g[y], y, g)) === S && ((S = !S) ? f.lineStart() : f.lineEnd()), S && f.point(+l(m, y, g), +o(m, y, g));
          if (x)
            return f = null, x + "" || null;
        }
        return p.x = function(g) {
          return arguments.length ? (l = typeof g == "function" ? g : L(+g), p) : l;
        }, p.y = function(g) {
          return arguments.length ? (o = typeof g == "function" ? g : L(+g), p) : o;
        }, p.defined = function(g) {
          return arguments.length ? (c = typeof g == "function" ? g : L(!!g), p) : c;
        }, p.curve = function(g) {
          return arguments.length ? (d = g, u != null && (f = d(u)), p) : d;
        }, p.context = function(g) {
          return arguments.length ? (g == null ? u = f = null : f = d(u = g), p) : u;
        }, p;
      }().x((l) => l[0]).y((l) => l[1]);
    ...
    }), this.chartScreen.append("rect").attr("width", this.width).attr("height", this.height).attr("fill", "none").on("mousemove", function(i) {
      const s = wt(this)[0], n = t.xScale.domain(), r = t.xScale.range(), a = Ws(r[0], r[1] + 1, t.xScale.step()), h = zs(a, s), l = n[h];
      t.dataSources.map((o, c) => {
        const u = t.dataFormat === "file" ? t.x === void 0 ? t.data[l] : t.data[h] : t.data[o][h], d = "." + o + "classtext";
        t.dataFormat === "file" ? A(d).selectAll("text").style("opacity", 1).html(t.x === void 0 ? `(${h},${u[o]})` : `(${t.x[h]}, ${u[o]})`).attr("x", t.x === void 0 ? t.xScale(h) : t.xScale(t.x[h])).attr("y", t.yScale(u[o]) - 6) : A(d).selectAll("text").style("opacity", 1).html(t.x === void 0 ? `(${h}, ${u})` : `(${t.x[h]}, ${u})`).attr("x", t.x === void 0 ? t.xScale(h) : t.xScale(t.x[h])).attr("y", t.yScale(u));
      });
    }).on("mouseout", () => {
      t.dataSources.map((i) => {
        A("." + i + "classtext").selectAll("text").style("opacity", 0);
      });
    });
  }
  initRoughObjects() {
  ...
  drawFromObject() {
    const t = this;
    this.colors === void 0 && (this.colors = vt), this.dataSources = Object.keys(this.data), this.initRoughObjects(), this.addScales(), this.dataSources.map((r, a) => {
      const h = this.data[r].map((c, u) => this.x === void 0 ? [this.xScale(u), this.yScale(+c)] : [this.xScale(this.x[u]), this.yScale(c)]), l = h.filter((c) => c[0] !== void 0), o = this.rc.curve(l, { stroke: t.colors.length === 1 ? t.colors[0] : t.colors[a], roughness: t.roughness, bowing: t.bowing });
      this.roughSvg.appendChild(o).setAttribute("class", this.graphClass), this.circle === !0 && h.forEach((c, u) => {
        const d = this.rc.circle(c[0], c[1], this.circleRadius, { stroke: this.colors[a], fill: this.colors[a], fillStyle: "solid", strokeWidth: 1, roughness: this.circleRoughness });
        this.roughSvg.appendChild(d);
      });
    });
    const i = this.dataSources.map((r, a) => ({ color: this.colors[a], text: r })), s = 6 * i.reduce((r, a) => r > a.text.length ? r : a.text.length, 0) + 35, n = 11 * i.length + 8;
    this.legend === !0 && ft(this, i, s, n, 2), this.addAxes(), this.addLabels(), this.makeAxesRough(this.roughSvg, this.rcAxis), this.interactive === !0 && this.addInteraction();
  }
  drawFromFile() {
    this.colors === void 0 && (this.colors = vt), this.initRoughObjects(), this.addScales(), this.dataSources.map((n, r) => {
      const a = this.data.map((o, c) => this.x === void 0 ? [this.xScale(c), this.yScale(o[n])] : [this.xScale(this.x[c]), this.yScale(+o[n])]), h = a.filter((o) => o[0] !== void 0), l = this.rc.curve(h, { stroke: this.colors[r], strokeWidth: this.strokeWidth, roughness: 1, bowing: 10 });
      this.roughSvg.appendChild(l), this.circle === !0 && h.forEach((o, c) => {
        const u = this.rc.circle(o[0], o[1], this.circleRadius, { stroke: this.colors[r], fill: this.colors[r], fillStyle: "solid", strokeWidth: 1, roughness: this.circleRoughness });
        this.roughSvg.appendChild(u);
      });
    });
    const t = this.dataSources.map((n, r) => ({ color: this.colors[r], text: n })), i = 6 * t.reduce((n, r) => n > r.text.length ? n : r.text.length, 0) + 35, s = 11 * t.length + 8;
    this.legend === !0 && ft(this, t, i, s, 2), this.addAxes(), this.addLabels(), this.makeAxesRough(this.roughSvg, this.rcAxis), this.interactive === !0 && this.addInteraction();
  }
}
function tn(e, t) {
  var i, s = 1;
  function n() {
    var r, a, h = i.length, l = 0, o = 0;
    for (r = 0; r < h; ++r)
      l += (a = i[r]).x, o += a.y;
    for (l = (l / h - e) * s, o = (o / h - t) * s, r = 0; r < h; ++r)
      (a = i[r]).x -= l, a.y -= o;
  }
  return e == null && (e = 0), t == null && (t = 0), n.initialize = function(r) {
    i = r;
  }, n.x = function(r) {
...
function ks(e, t, i, s) {
  if (isNaN(t) || isNaN(i))
    return e;
  var n, r, a, h, l, o, c, u, d, f = e._root, p = { data: s }, g = e._x0, y = e._y0, m = e._x1, x = e._y1;
  if (!f)
    return e._root = p, e;
  for (; f.length; )
    if ((o = t >= (r = (g + m) / 2)) ? g = r : m = r, (c = i >= (a = (y + x) / 2)) ? y = a : x = a, n = f, !(f = f[u = c << 1 | o]))
      return n[u] = p, e;
  if (h = +e._x.call(null, f.data), l = +e._y.call(null, f.data), t === h && i === l)
    return p.next = f, n ? n[u] = p : e._root = p, e;
  do
    n = n ? n[u] = new Array(4) : e._root = new Array(4), (o = t >= (r = (g + m) / 2)) ? g = r : m = r, (c = i >= (a = (y + x) / 2)) ? y = a : x = a;
  while ((u = c << 1 | o) == (d = (l >= a) << 1 | h >= r));
  return n[d] = f, n[u] = p, e;
}
function q(e, t, i, s, n) {
  this.node = e, this.x0 = t, this.y0 = i, this.x1 = s, this.y1 = n;
}
function cr(e) {
  return e[0];
}
...
function en(e, t, i) {
  var s = new yi(t ?? cr, i ?? ur, NaN, NaN, NaN, NaN);
  return e == null ? s : s.addAll(e);
}
function yi(e, t, i, s, n, r) {
  this._x = e, this._y = t, this._x0 = i, this._y0 = s, this._x1 = n, this._y1 = r, this._root = void 0;
}
function ws(e) {
  for (var t = { data: e.data }, i = t; e = e.next; )
    i = i.next = { data: e.data };
  return t;
}
var V = en.prototype = yi.prototype;
function Yt(e) {
  return function() {
    return e;
  };
...
function sn(e) {
  var t, i, s, n = 1, r = 1;
  function a() {
    for (var o, c, u, d, f, p, g, y = t.length, m = 0; m < r; ++m)
      for (c = en(t, dr, fr).visitAfter(h), o = 0; o < y; ++o)
        u = t[o], p = i[u.index], g = p * p, d = u.x + u.vx, f = u.y + u.vy, c.visit(x);
    function x(k, S, R, v, M) {
      var F = k.data, E = k.r, W = p + E;
      if (!F)
        return S > d + W || v < d - W || R > f + W || M < f - W;
      if (F.index > u.index) {
        var z = d - F.x - F.vx, w = f - F.y - F.vy, j = z * z + w * w;
        j < W * W && (z === 0 && (j += (z = pe(s)) * z), w === 0 && (j += (w = pe(s)) * w), j = (W - (j = Math.sqrt(j))) / j * n, u.vx += (z *= j) * (W = (E *= E) / (g + E)), u.vy += (w *= j) * W, F.vx -= z * (W = 1 - W), F.vy -= w * W);
      }
    }
  }
  function h(o) {
    if (o.data)
      return o.r = i[o.data.index];
  ...
  function l() {
    if (t) {
      var o, c, u = t.length;
      for (i = new Array(u), o = 0; o < u; ++o)
        c = t[o], i[c.index] = +e(c, o, t);
    }
  }
  return typeof e != "function" && (e = Yt(e == null ? 1 : +e)), a.initialize = function(o, c) {
    t = o, s = c, l();
    ...
    return arguments.length ? (e = typeof o == "function" ? o : Yt(+o), l(), a) : e;
  }, a;
}
function gr(e) {
  return e.index;
...
V.copy = function() {
  var e, t, i = new yi(this._x, this._y, this._x0, this._y0, this._x1, this._y1), s = this._root;
  if (!s)
    return i;
  if (!s.length)
    return i._root = ws(s), i;
  for (e = [{ source: s, target: i._root = new Array(4) }]; s = e.pop(); )
    for (var n = 0; n < 4; ++n)
      (t = s.source[n]) && (t.length ? e.push({ source: t, target: s.target[n] = new Array(4) }) : s.target[n] = ws(t));
  return i;
}, V.add = function(e) {
  const t = +this._x.call(null, e), i = +this._y.call(null, e);
  return ks(this.cover(t, i), t, i, e);
}, V.addAll = function(e) {
  var t, i, s, n, r = e.length, a = new Array(r), h = new Array(r), l = 1 / 0, o = 1 / 0, c = -1 / 0, u = -1 / 0;
  for (i = 0; i < r; ++i)
    isNaN(s = +this._x.call(null, t = e[i])) || isNaN(n = +this._y.call(null, t)) || (a[i] = s, h[i] = n, s < l && (l = s), s > c && (c = s), n < o && (o = n), n > u && (u = n));
  if (l > c || o > u)
    return this;
  for (this.cover(l, o).cover(c, u), i = 0; i < r; ++i)
    ks(this, a[i], h[i], e[i]);
  return this;
}, V.cover = function(e, t) {
  if (isNaN(e = +e) || isNaN(t = +t))
    return this;
  var i = this._x0, s = this._y0, n = this._x1, r = this._y1;
  if (isNaN(i))
    n = (i = Math.floor(e)) + 1, r = (s = Math.floor(t)) + 1;
  else {
    for (var a, h, l = n - i || 1, o = this._root; i > e || e >= n || s > t || t >= r; )
      switch (h = (t < s) << 1 | e < i, (a = new Array(4))[h] = o, o = a, l *= 2, h) {
        case 0:
          n = i + l, r = s + l;
          break;
        case 1:
  ...
  return this._x0 = i, this._y0 = s, this._x1 = n, this._y1 = r, this;
}, V.data = function() {
  var e = [];
...
}, V.find = function(e, t, i) {
  var s, n, r, a, h, l, o, c = this._x0, u = this._y0, d = this._x1, f = this._y1, p = [], g = this._root;
  for (g && p.push(new q(g, c, u, d, f)), i == null ? i = 1 / 0 : (c = e - i, u = t - i, d = e + i, f = t + i, i *= i); l = p.pop(); )
    if (!(!(g = l.node) || (n = l.x0) > d || (r = l.y0) > f || (a = l.x1) < c || (h = l.y1) < u))
      if (g.length) {
        var y = (n + a) / 2, m = (r + h) / 2;
        p.push(new q(g[3], y, m, a, h), new q(g[2], n, m, y, h), new q(g[1], y, r, a, m), new q(g[0], n, r, y, m)), (o = (t >= m) << 1 | e >= y) && (l = p[p.length - 1], p[p.length - 1] = p[p.length - 1 - o], p[p.length - 1 - o] = l);
      } else {
        var x = e - +this._x.call(null, g.data), k = t - +this._y.call(null, g.data), S = x * x + k * k;
        if (S < i) {
          var R = Math.sqrt(i = S);
          c = e - R, u = t - R, d = e + R, f = t + R, s = g.data;
        }
      }
  return s;
}, V.remove = function(e) {
  if (isNaN(r = +this._x.call(null, e)) || isNaN(a = +this._y.call(null, e)))
    return this;
  var t, i, s, n, r, a, h, l, o, c, u, d, f = this._root, p = this._x0, g = this._y0, y = this._x1, m = this._y1;
  if (!f)
    return this;
  if (f.length)
    for (; ; ) {
      if ((o = r >= (h = (p + y) / 2)) ? p = h : y = h, (c = a >= (l = (g + m) / 2)) ? g = l : m = l, t = f, !(f = f[u = c << 1 | o]))
        return this;
      if (!f.length)
        break;
  ...
  for (; f.data !== e; )
    if (s = f, !(f = f.next))
      return this;
  return (n = f.next) && delete f.next, s ? (n ? s.next = n : delete s.next, this) : t ? (n ? t[u] = n : delete t[u], (f = t[0] || t[1] || t[2] || t[3]) && f === (t[3] || t[2] || t[1] || t[0]) && !f.length && (i ? i[d] = f : this._root = f), this) : (this._root = n, this);
}, V.removeAll = function(e) {
  ...
  var t, i, s, n, r, a, h = [], l = this._root;
  for (l && h.push(new q(l, this._x0, this._y0, this._x1, this._y1)); t = h.pop(); )
    if (!e(l = t.node, s = t.x0, n = t.y0, r = t.x1, a = t.y1) && l.length) {
      var o = (s + r) / 2, c = (n + a) / 2;
      (i = l[3]) && h.push(new q(i, o, c, r, a)), (i = l[2]) && h.push(new q(i, s, c, o, a)), (i = l[1]) && h.push(new q(i, o, n, r, c)), (i = l[0]) && h.push(new q(i, s, n, o, c));
    }
  return this;
}, V.visitAfter = function(e) {
  var t, i = [], s = [];
  for (this._root && i.push(new q(this._root, this._x0, this._y0, this._x1, this._y1)); t = i.pop(); ) {
    var n = t.node;
    if (n.length) {
      var r, a = t.x0, h = t.y0, l = t.x1, o = t.y1, c = (a + l) / 2, u = (h + o) / 2;
      (r = n[0]) && i.push(new q(r, a, h, c, u)), (r = n[1]) && i.push(new q(r, c, h, l, u)), (r = n[2]) && i.push(new q(r, a, u, c, o)), (r = n[3]) && i.push(new q(r, c, u, l, o));
    }
    s.push(t);
  }
  for (; t = s.pop(); )
...
function nn() {
  for (var e, t = 0, i = arguments.length, s = {}; t < i; ++t) {
    if (!(e = arguments[t] + "") || e in s || /[\s.]/.test(e))
...
function Ms(e, t, i) {
  for (var s = 0, n = e.length; s < n; ++s)
    if (e[s].name === t) {
      e[s] = pr, e = e.slice(0, s).concat(e.slice(s + 1));
      break;
    }
  return i != null && e.push({ name: t, value: i }), e;
}
ne.prototype = nn.prototype = { constructor: ne, on: function(e, t) {
  var i, s, n = this._, r = (s = n, (e + "").trim().split(/^|\s+/).map(function(l) {
    var o = "", c = l.indexOf(".");
    if (c >= 0 && (o = l.slice(c + 1), l = l.slice(0, c)), l && !s.hasOwnProperty(l))
  ...
  if (!(arguments.length < 2)) {
    ...
    for (; ++a < h; )
      if (i = (e = r[a]).type)
        ...
        for (i in n)
          n[i] = Ms(n[i], e.name, null);
    return this;
  }
  for (; ++a < h; )
    if ((i = (e = r[a]).type) && (i = mr(n[i], e.name)))
      return i;
}, copy: function() {
  var e = {}, t = this._;
  for (var i in t)
  ...
  if ((i = arguments.length - 2) > 0)
    for (var i, s, n = new Array(i), r = 0; r < i; ++r)
      n[r] = arguments[r + 2];
  if (!this._.hasOwnProperty(e))
    throw new Error("unknown type: " + e);
  for (r = 0, i = (s = this._[e]).length; r < i; ++r)
    s[r].value.apply(t, n);
}, apply: function(e, t, i) {
  if (!this._.hasOwnProperty(e))
    throw new Error("unknown type: " + e);
  for (var s = this._[e], n = 0, r = s.length; n < r; ++n)
    s[n].value.apply(t, i);
} };
var he, Tt, zt = 0, Zt = 0, Lt = 0, hn = 1e3, me = 0, xt = 0, be = 0, Ht = typeof performance == "object" && performance.now ? performance : Date, rn = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(e) {
  setTimeout(e, 17);
};
function an() {
  return xt || (rn(yr), xt = Ht.now() + be);
}
function yr() {
  xt = 0;
}
...
function Ps() {
  ...
  try {
    ...
    zt = 0, function() {
      for (var e, t, i = he, s = 1 / 0; i; )
        i._call ? (s > i._time && (s = i._time), e = i, i = i._next) : (t = i._next, i._next = null, i = e ? e._next = t : he = t);
      Tt = e, li(s);
    }(), xt = 0;
  }
}
...
function li(e) {
  zt || (Zt && (Zt = clearTimeout(Zt)), e - xt > 24 ? (e < 1 / 0 && (Zt = setTimeout(Ps, e - Ht.now() - be)), Lt && (Lt = clearInterval(Lt))) : (Lt || (me = Ht.now(), Lt = setInterval(Ar, hn)), zt = 1, rn(Ps)));
}
oi.prototype = on.prototype = { constructor: oi, restart: function(e, t, i) {
  if (typeof e != "function")
    throw new TypeError("callback is not a function");
  i = (i == null ? an() : +i) + (t == null ? 0 : +t), this._next || Tt === this || (Tt ? Tt._next = this : he = this, Tt = this), this._call = e, this._time = i, li();
}, stop: function() {
  this._call && (this._call = null, this._time = 1 / 0, li());
} };
const xr = 1664525, vr = 1013904223, Rs = 4294967296;
var br = Math.PI * (3 - Math.sqrt(5));
function ln(e) {
  var t, i = 1, s = 1e-3, n = 1 - Math.pow(s, 1 / 300), r = 0, a = 0.6, h = /* @__PURE__ */ new Map(), l = on(u), o = nn("tick", "end"), c = function() {
    let g = 1;
    return () => (g = (xr * g + vr) % Rs) / Rs;
  }();
  function u() {
    d(), o.call("tick", t), i < s && (l.stop(), o.call("end", t));
  }
  function d(g) {
    var y, m, x = e.length;
    g === void 0 && (g = 1);
    for (var k = 0; k < g; ++k)
      for (i += (r - i) * n, h.forEach(function(S) {
        S(i);
      }), y = 0; y < x; ++y)
        (m = e[y]).fx == null ? m.x += m.vx *= a : (m.x = m.fx, m.vx = 0), m.fy == null ? m.y += m.vy *= a : (m.y = m.fy, m.vy = 0);
    return t;
  }
  function f() {
    for (var g, y = 0, m = e.length; y < m; ++y) {
      if ((g = e[y]).index = y, g.fx != null && (g.x = g.fx), g.fy != null && (g.y = g.fy), isNaN(g.x) || isNaN(g.y)) {
        var x = 10 * Math.sqrt(0.5 + y), k = y * br;
        g.x = x * Math.cos(k), g.y = x * Math.sin(k);
      }
  ...
  return e == null && (e = []), f(), t = { tick: d, restart: function() {
    return l.restart(u), t;
  }, stop: function() {
    return l.stop(), t;
  }, nodes: function(g) {
    return arguments.length ? (e = g, f(), h.forEach(p), t) : e;
  }, alpha: function(g) {
    ...
    return arguments.length ? (c = g, h.forEach(p), t) : c;
  }, force: function(g, y) {
    return arguments.length > 1 ? (y == null ? h.delete(g) : h.set(g, p(y)), t) : h.get(g);
  }, find: function(g, y, m) {
    var x, k, S, R, v, M = 0, F = e.length;
    for (m == null ? m = 1 / 0 : m *= m, M = 0; M < F; ++M)
      (S = (x = g - (R = e[M]).x) * x + (k = y - R.y) * k) < m && (v = R, m = S);
    return v;
  }, on: function(g, y) {
    return arguments.length > 1 ? (o.on(g, y), t) : o.on(g);
  } };
}
class Pr extends ct {
  constructor(t) {
  ...
  initChartValues(t) {
    this.roughness = t.roughness || this.roughness, this.collision = t.collision || this.collision, this.color = t.color || this.color, this.stroke = t.stroke || this.stroke, this.strokeWidth = t.strokeWidth || this.strokeWidth, this.axisStrokeWidth = t.axisStrokeWidth || this.axisStrokeWidth, this.axisRoughness = t.axisRoughness || this.axisRoughness, this.innerStrokeWidth = t.innerStrokeWidth || this.innerStrokeWidth, this.fillWeight = t.fillWeight || this.fillWeight, this.fillStyle = t.fillStyle || this.fillStyle, this.title = t.title || this.title, this.textCallback = t.textCallback || ((r) => "");
    const i = A(this.el).node().getBoundingClientRect(), s = i.width, n = i.height;
    this.width = s - this.margin.left - this.margin.right, this.height = n - this.margin.top - this.margin.bottom, this.roughId = this.el + "_svg", this.graphClass = this.el.substring(1, this.el.length), this.interactionG = "g." + this.graphClass, this.setSvg();
  }
  resolveData(t, i) {
    return () => {
      this.data = t, this.links = i, this.drawFromObject();
    };
  }
  setTitle(t) {
    this.svg.append("text").attr("x", this.width / 2).attr("y", 0 - this.margin.top / 3).attr("class", "title").attr("text-anchor", "middle").style("font-size", this.titleFontSize === void 0 ? `${Math.min(40, Math.min(this.width, this.height) / 4)}px` : this.titleFontSize).style("font-family", this.fontFamily).style("opacity", 0.8).text(t);
  ...
  addInteraction() {
    ...
    P(".nodeGroup").on("mouseover", function(s) {
      A(this).raise(), i = A(this).selectAll("path").style("stroke"), t.highlight === void 0 ? A(this).selectAll("path:nth-child(1)").style("opacity", 0.4) : A(this).selectAll("path:nth-child(1)").style("stroke", t.highlight), A(this).selectAll("path:nth-child(2)").style("stroke-width", t.strokeWidth + 1.2), A(this).select(".node-text").attr("opacity", 1);
    }).on("mouseleave", function(s) {
      A(this).selectAll("path:nth-child(1)").style("opacity", 1), A(this).selectAll("path:nth-child(1)").style("stroke", i), A(this).selectAll("path:nth-child(2)").style("stroke-width", t.innerStrokeWidth), A(this).select(".node-text").attr("opacity", 0);
    });
  }
  initRoughObjects() {
  ...
  drawFromObject() {
    ...
    if (typeof this.radius == "number")
      i = O().domain([0, 1]).range([this.extent[0], this.radiusExtent[1]]);
    else {
      const h = dt(this.data, (o) => +o[this.radius]), l = D(this.data, (o) => +o[this.radius]);
      i = O().domain([h, l]).range([this.radiusExtent[0], this.radiusExtent[1]]);
    }
    if (typeof this.roughness == "number")
      s = O().domain([0, 1]).range([this.roughnessExtent[0], this.roughnessExtent[1]]);
    else {
      const h = dt(this.data, (o) => +o[this.radius]), l = D(this.data, (o) => +o[this.radius]);
      s = O().domain([h, l]).range([this.roughnessExtent[0], this.roughnessExtent[1]]);
    }
    ...
    r.each(function(h, l) {
      const o = typeof t.radius == "number" ? t.radius : i(h[t.radius]), c = typeof t.roughness == "number" ? t.roughness : s(h[t.roughness]), u = t.rc.circle(0, 0, o, { fill: t.colorCallback(h), simplification: t.simplification, fillWeight: t.fillWeight, roughness: c });
      this.appendChild(u), u.setAttribute("class", t.graphClass + "_node"), A(this).append("circle").attr("class", "node-circle").attr("r", 0.5 * o).attr("fill", "transparent").attr("stroke-width", 0).attr("stroke", "none"), A(this).append("text").attr("class", "node-text").attr("x", 0).attr("y", -10).attr("text-anchor", "middle").style("pointer-events", "none").attr("stroke", "black").attr("fill", "white").attr("stroke-linejoin", "fill").attr("paint-order", "stroke fill").attr("stroke-width", "5px").attr("opacity", 0).text((d) => t.textCallback(d));
    });
    const a = ln(this.data);
    if (a.alpha(1).restart(), a.force("collide", sn().radius((h) => h.radius * this.collision)).force("center", tn(this.width / 2, this.height / 2)).force("link", function(h) {
      var l, o, c, u, d, f, p = gr, g = function(v) {
        return 1 / Math.min(u[v.source.index], u[v.target.index]);
      }, y = Yt(30), m = 1;
      function x(v) {
        for (var M = 0, F = h.length; M < m; ++M)
          for (var E, W, z, w, j, H, Z, C = 0; C < F; ++C)
            W = (E = h[C]).source, w = (z = E.target).x + z.vx - W.x - W.vx || pe(f), j = z.y + z.vy - W.y - W.vy || pe(f), w *= H = ((H = Math.sqrt(w * w + j * j)) - o[C]) / H * v * l[C], j *= H, z.vx -= w * (Z = d[C]), z.vy -= j * Z, W.vx += w * (Z = 1 - Z), W.vy += j * Z;
      }
      function k() {
        if (c) {
          var v, M, F = c.length, E = h.length, W = new Map(c.map((z, w) => [p(z, w, c), z]));
          for (v = 0, u = new Array(F); v < E; ++v)
            (M = h[v]).index = v, typeof M.source != "object" && (M.source = Ss(W, M.source)), typeof M.target != "object" && (M.target = Ss(W, M.target)), u[M.source.index] = (u[M.source.index] || 0) + 1, u[M.target.index] = (u[M.target.index] || 0) + 1;
          for (v = 0, d = new Array(E); v < E; ++v)
            M = h[v], d[v] = u[M.source.index] / (u[M.source.index] + u[M.target.index]);
          l = new Array(E), S(), o = new Array(E), R();
        }
      }
      function S() {
        if (c)
      ...
      return h == null && (h = []), x.initialize = function(v, M) {
        c = v, f = M, k();
      }, x.links = function(v) {
        return arguments.length ? (h = v, k(), x) : h;
      }, x.id = function(v) {
        return arguments.length ? (p = v, x) : p;
      }, x.iterations = function(v) {
        return arguments.length ? (m = +v, x) : m;
      }, x.strength = function(v) {
        return arguments.length ? (g = typeof v == "function" ? v : Yt(+v), S(), x) : g;
      }, x.distance = function(v) {
        return arguments.length ? (y = typeof v == "function" ? v : Yt(+v), R(), x) : y;
      }, x;
      ...
      const h = this.legend;
      this.colors = this.legend.map((c) => c.color);
      const l = 6 * h.reduce((c, u) => c > u.text.length ? c : u.text.length, 0) + 35, o = 11 * h.length + 8;
      ft(this, h, l, o);
    }
  }
}
class Rr extends ct {
  ...
  addInteraction() {
    ...
    let i;
    P(".nodeGroup").on("mouseover", function(s) {
      i = A(this).selectAll("path").style("stroke"), A(this).raise(), t.highlight === void 0 ? A(this).selectAll("path:nth-child(1)").style("opacity", 0.4) : A(this).selectAll("path:nth-child(1)").style("stroke", t.highlight), A(this).selectAll("path:nth-child(2)").style("stroke-width", t.strokeWidth + 1.2), A(this).select(".node-text").attr("opacity", 1), A(this).select(".node-text").raise();
    }).on("mouseleave", function(s) {
      A(this).selectAll("path:nth-child(1)").style("opacity", 1), A(this).selectAll("path:nth-child(1)").style("stroke", i), A(this).selectAll("path:nth-child(2)").style("stroke-width", t.strokeWidth), A(this).select(".node-text").attr("opacity", 0);
    });
  }
  initRoughObjects() {
    this.roughSvg = document.getElementById(this.roughId), this.rcAxis = B(this.roughSvg, { options: { strokeWidth: this.strokeWidth >= 3 ? 3 : this.strokeWidth } }), this.rc = B(this.roughSvg, { options: { strokeWidth: this.innerStrokeWidth, fill: this.color, stroke: this.stroke === "none" ? void 0 : this.stroke, roughness: this.roughness, bowing: this.bowing, fillStyle: this.fillStyle } });
  ...
  drawFromObject() {
    ...
    let i, s;
    if (typeof this.radius == "number")
      i = O().domain([0, 1]).range([this.radiusExtent[0], this.radiusExtent[1]]);
    else {
      const h = dt(this.data, (o) => +o[this.radius]), l = D(this.data, (o) => +o[this.radius]);
      i = O().domain([h, l]).range([this.radiusExtent[0], this.radiusExtent[1]]);
    }
    ...
    n = n.merge(r), n.each(function(h, l) {
      const o = typeof t.radius == "number" ? t.radius : i(h[t.radius]), c = typeof t.roughness == "number" ? t.roughness : s(h[t.roughness]), u = t.rc.circle(0, 0, o, { fill: t.colorCallback(h), simplification: t.simplification, fillWeight: t.fillWeight, roughness: c });
      this.appendChild(u).setAttribute("class", t.graphClass + "_node"), A(this).append("circle").attr("class", "node-circle").attr("r", 0.5 * o).attr("fill", "transparent").attr("stroke-width", 0).attr("stroke", "none"), A(this).append("text").attr("class", "node-text").attr("x", 0).attr("y", -10).attr("text-anchor", "middle").style("pointer-events", "none").attr("stroke", "black").attr("fill", "white").attr("stroke-linejoin", "fill").attr("paint-order", "stroke fill").attr("stroke-width", "5px").attr("opacity", 0).text((d) => t.textCallback(d));
    });
    const a = ln(this.data);
    if (a.alpha(1).restart(), a.force("collide", sn().radius((h) => h.radius * this.collision * 1.2)).force("center", tn(this.width / 2, this.height / 2)), a.on("tick", () => {
...
class zr extends ct {
  ...
  initRoughObjects() {
    this.roughSvg = document.getElementById(this.roughId), this.rcAxis = B(this.roughSvg, { options: { strokeWidth: this.strokeWidth >= 3 ? 3 : this.strokeWidth } }), this.rc = B(this.roughSvg, { options: { fill: this.color, strokeWidth: this.innerStrokeWidth, roughness: this.roughness, bowing: this.bowing, fillStyle: this.fillStyle } });
  }
  drawFromObject() {
    this.initRoughObjects(), this.makePie = ge(), this.makeArc = fe().innerRadius(0).outerRadius(this.radius), this.arcs = this.makePie(this.data[this.values]), this.arcs.forEach((n, r) => {
      if (n.value !== 0) {
        ...
        h.setAttribute("attrY", this.data[this.values][r]), h.setAttribute("attrX", this.data[this.labels][r]);
      }
    }), P(this.interactionG).selectAll("path:nth-child(2)").style("stroke-width", this.strokeWidth);
    const t = this.data.labels.map((n, r) => ({ color: this.colors[r], text: n })), i = 6 * t.reduce((n, r) => n > r.text.length ? n : r.text.length, 0) + 35, s = 11 * t.length + 8;
    this.legend === !0 && ft(this, t, i, s), this.interactive === !0 && this.addInteraction();
  }
  drawFromFile() {
    this.initRoughObjects(), this.makePie = ge().value((r) => r[this.values]).sort(null);
    const t = [];
    this.makeArc = fe().innerRadius(0).outerRadius(this.radius), this.arcs = this.makePie(this.data), this.arcs.forEach((r, a) => {
      if (r.value !== 0) {
        const h = this.rc.arc(this.width / 2, this.height / 2, 2 * this.radius, 2 * this.radius, r.startAngle - Math.PI / 2, r.endAngle - Math.PI / 2, !0, { fill: this.colors[a], stroke: this.colors[a] });
        h.setAttribute("class", this.graphClass);
        const l = this.roughSvg.appendChild(h);
        l.setAttribute("attrY", r.data[this.values]), l.setAttribute("attrX", r.data[this.labels]);
      }
      t.push(r.data[this.labels]);
    }), P(this.interactionG).selectAll("path:nth-child(2)").style("stroke-width", this.strokeWidth);
    const i = t.map((r, a) => ({ color: this.colors[a], text: r })), s = 6 * i.reduce((r, a) => r > a.text.length ? r : a.text.length, 0) + 35, n = 11 * i.length + 8;
    this.legend === !0 && ft(this, i, s, n), this.interactive === !0 && this.addInteraction();
  }
}
const De = ["pink", "skyblue", "coral", "gold", "teal", "darkgreen", "brown", "slateblue", "orange"];
class Wr extends ct {
  constructor(t) {
    super(t), this.margin = t.margin || { top: 50, right: 20, bottom: 50, left: 100 }, this.colorVar = t.colorVar, this.roughness = at({ roughness: t.roughness }), this.highlight = t.highlight, this.highlightLabel = t.highlightLabel || "xy", this.radiusExtent = t.radiusExtent || [5, 20], this.radius = t.radius || 20, this.axisStrokeWidth = t.axisStrokeWidth || 0.4, this.axisRoughness = t.axisRoughness || 0.9, this.curbZero = t.curbZero === !0, this.innerStrokeWidth = t.innerStrokeWidth || 1, this.stroke = t.stroke || "black", this.fillWeight = t.fillWeight || 0.85, this.colors = t.colors || De, this.strokeWidth = t.strokeWidth || 1, this.axisFontSize = t.axisFontSize, this.x = this.dataFormat === "object" ? "x" : t.x, this.y = this.dataFormat === "object" ? "y" : t.y, this.xValueFormat = t.xValueFormat, this.yValueFormat = t.yValueFormat, this.xLabel = t.xLabel || "", this.yLabel = t.yLabel || "", this.labelFontSize = t.labelFontSize || "1rem", this.responsive = !0, this.boundRedraw = this.redraw.bind(this, t), this.radiusScale, this.initChartValues(t), this.resolveFont(), this.drawChart = this.resolveData(t.data), this.drawChart(), t.title !== "undefined" && this.setTitle(t.title), window.addEventListener("resize", this.resizeHandler.bind(this));
  }
  resizeHandler() {
    this.responsive && this.boundRedraw();
  }
  ...
  addScaleLine() {
    ...
    if (this.x === void 0) {
      ...
      i = et(this.x);
    const s = t, n = s[1] - s[0];
    this.xScale = this.x === void 0 ? scalePoint().range([0, this.width]).domain([...Array(i[1]).keys()]) : scalePoint().range([0, this.width]).domain(this.x), this.yScale = O().range([this.height, 0]).domain([0, s[1] + 0.05 * n]);
  }
  addScales() {
    const t = this.dataFormat === "file" ? et(this.data, (a) => +a[this.x]) : et(this.data[this.x]), i = t[1] - t[0], s = this.dataFormat === "file" ? et(this.data, (a) => +a[this.y]) : et(this.data[this.y]), n = s[1] - s[0], r = this.dataFormat === "file" ? et(this.data, (a) => a[this.colorVar]) : [1, 1];
    if (this.dataFormat === "file") {
      const a = et(this.data, (l) => +l[this.radius]), h = Math.min(this.width, this.height) / 2 / 2;
      this.radiusScale = O().range([8, h]).domain(a);
    } else
      this.radiusScale = O().domain([0, 20]).range([this.radiusExtent[0], this.radiusExtent[1]]);
    this.curbZero === !0 && (s[0] > 0 && (s[0] = 0), t[0] > 0 && (t[0] = 0)), this.xScale = O().range([0, this.width]).domain([t[0] - 0.05 * i, t[1] + 0.05 * i]), this.yScale = O().range([this.height, 0]).domain([s[0] - 0.05 * n, s[1] + 0.05 * n]), this.colorScale = ye().range(this.colors).domain(r);
  }
  addLabels() {
    this.xLabel !== "" && this.svg.append("text").attr("x", this.width / 2).attr("y", this.height + this.margin.bottom / 1.3).attr("dx", "1em").attr("class", "labelText").style("text-anchor", "middle").style("font-family", this.fontFamily).style("font-size", this.labelFontSize).text(this.xLabel), this.yLabel !== "" && this.svg.append("text").attr("transform", "rotate(-90)").attr("y", 0 - this.margin.left / 2).attr("x", 0 - this.height / 2).attr("dy", "1em").attr("class", "labelText").style("text-anchor", "middle").style("font-family", this.fontFamily).style("font-size", this.labelFontSize).text(this.yLabel);
  }
  ...
  addInteraction() {
    const t = P(this.interactionG).data(this.dataFormat === "file" ? this.data : this.data.x).append("circle").attr("cx", (r, a) => this.dataFormat === "file" ? this.xScale(+r[this.x]) : this.xScale(+this.data[this.x][a])).attr("cy", (r, a) => this.dataFormat === "file" ? this.yScale(+r[this.y]) : this.yScale(+this.data[this.y][a]));
    ...
    let i = A(this.el).append("div").style("opacity", 0).attr("class", "tooltip").style("position", "absolute").style("background-color", "white").style("border", "solid").style("border-width", "1px").style("border-radius", "5px").style("padding", "3px").style("font-family", this.fontFamily).style("font-size", this.tooltipFontSize).style("pointer-events", "none");
    const s = this;
    let n;
    P(this.interactionG).on("mouseover", function() {
      i.style("opacity", 1), n = A(this).selectAll("path").style("stroke"), s.highlight === void 0 ? A(this).selectAll("path:nth-child(1)").style("opacity", 0.4) : A(this).selectAll("path:nth-child(1)").style("stroke", s.highlight), A(this).selectAll("path:nth-child(2)").style("stroke-width", s.strokeWidth + 1.2);
    }), P(this.interactionG).on("mouseout", function() {
      i.style("opacity", 0), A(this).selectAll("path").style("opacity", 1), A(this).selectAll("path:nth-child(1)").style("stroke", n), A(this).selectAll("path:nth-child(2)").style("stroke", s.stroke), A(this).selectAll("path:nth-child(2)").style("stroke-width", s.strokeWidth);
    }), P(this.interactionG).on("mousemove", function(r) {
      const a = A(this).attr("attrX"), h = A(this).attr("attrY"), l = A(this).attr("attrHighlightLabel"), o = wt(this);
      i.html(s.highlightLabel === "xy" ? `<b>x</b>: ${a} <br><b>y</b>: ${h}` : `<b>${l}</b>`).attr("class", function(c) {
      }).style("transform", `translate(${o[0] + s.margin.left}px, 
          ${o[1] - (s.height + s.margin.top + s.margin.bottom / 2)}px)`);
    });
  }
  initRoughObjects() {
    this.roughSvg = document.getElementById(this.roughId), this.rcAxis = B(this.roughSvg, { options: { strokeWidth: this.axisStrokeWidth, roughness: this.axisRoughness } }), this.rc = B(this.roughSvg, { options: { stroke: this.stroke === "none" ? void 0 : this.stroke, strokeWidth: this.innerStrokeWidth, roughness: this.roughness, bowing: this.bowing, fillStyle: this.fillStyle } });
  ...
  drawFromObject() {
    const t = this;
    let i;
    if (this.radiusScale = O().domain([0, 20]).range([this.radiusExtent[0], this.radiusExtent[1]]), typeof this.radius == "number")
      i = O().domain([0, 1]).range([this.radiusExtent[0], this.radiusExtent[1]]);
    else {
      const s = dt(this.data[this.radius]), n = D(this.data[this.radius]);
      i = O().domain([s, n]).range([this.radiusExtent[0], this.radiusExtent[1]]);
    }
    typeof this.colors == "string" && (this.colors = this.colors), this.colors === void 0 && (this.colors = De[0]), this.initRoughObjects(), this.addScales(), this.addAxes(), this.makeAxesRough(this.roughSvg, this.rcAxis), this.addLabels(), this.data.x.forEach((s, n) => {
      const r = typeof t.radius == "number" ? t.radius : i(+this.data[t.radius][n]), a = this.rc.circle(this.xScale(+s), this.yScale(+this.data[this.y][n]), r, { fill: typeof this.colors == "string" ? this.colors : this.colors.length === 1 ? this.colors[0] : this.colors[n], simplification: this.simplification, fillWeight: this.fillWeight }), h = this.roughSvg.appendChild(a);
  ...
  drawFromFile() {
    this.colors === void 0 && (this.colors = De), this.initRoughObjects(), this.addScales(), this.addAxes(), this.makeAxesRough(this.roughSvg, this.rcAxis), this.addLabels(), this.data.forEach((t, i) => {
...
class Fr extends ct {
  ...
  getTotal(t) {
    for (let i = 0; i < t.length; i++) {
      ...
      for (let n = 0; n < t.columns.length; ++n)
        t.columns[n] !== this.labels && (s += t[i][t.columns[n]] = +t[i][t.columns[n]]);
      t[i].total = s;
    }
    return t;
  }
  updateColorMapping(t) {
    this.stackColorMapping[t] || (this.stackColorMapping[t] = vt[Object.keys(this.stackColorMapping).length]);
  }
  resolveData(t) {
    return typeof t != "string" ? () => {
      this.data = t, t = t.map((i) => (Object.keys(i).includes("total") && (i.total = 0), i));
      for (let i = 0; i < t.length; ++i) {
        let s = 0;
        Object.keys(t[i]).forEach((n) => {
          n !== this.labels && n !== "total" && (this.updateColorMapping(n), s += t[i][n]);
        }), t[i].total = s;
      }
      this.drawFromObject();
    } : t.includes(".csv") ? () => {
      bt(t).then((i) => {
        this.getTotal(i), this.data = i, this.drawFromFile();
      });
    } : t.includes(".tsv") ? () => {
      kt(t).then((i) => {
        this.getTotal(i), this.data = i, this.drawFromFile();
  ...
  addScales() {
    this.xScale = Qt().rangeRound([0, this.width]).padding(this.padding).domain(this.data.map((i) => i[this.labels])), this.yScale = O().rangeRound([this.height, 0]).domain([0, D(this.data, (i) => i.total)]).nice();
    const t = this.dataFormat === "object" ? this.data.map((i) => i[this.labels]) : this.data.columns;
    this.zScale = ye().range(["#98abc5", "#8a89a6", "#7b6888", "#6b486b", "#a05d56", "#d0743c", "#ff8c00"]).domain(t);
  }
  addLabels() {
    this.xLabel !== "" && this.svg.append("text").attr("x", this.width / 2).attr("y", this.height + this.margin.bottom / 2).attr("dx", "1em").attr("class", "labelText").style("text-anchor", "middle").style("font-family", this.fontFamily).style("font-size", this.labelFontSize).text(this.xLabel), this.yLabel !== "" && this.svg.append("text").attr("transform", "rotate(-90)").attr("y", 0 - this.margin.left / 1.4).attr("x", 0 - this.height / 2).attr("dy", "1em").attr("class", "labelText").style("text-anchor", "middle").style("font-family", this.fontFamily).style("font-size", this.labelFontSize).text(this.yLabel);
  }
  addAxes() {
    const t = Xt(this.xScale).tickSize(0);
    ...
    const i = Kt(this.yScale).tickSize(0);
    this.svg.append("g").call(i).attr("class", `yAxis${this.graphClass}`).selectAll("text").style("font-family", this.fontFamily).style("font-size", this.axisFontSize === void 0 ? `${Math.min(0.95, Math.min(this.width, this.height) / 140)}rem` : this.axisFontSize).style("opacity", 0.9), P("path.domain").attr("stroke", "transparent");
  }
  makeAxesRough(t, i) {
    const s = `xAxis${this.graphClass}`, n = `yAxis${this.graphClass}`, r = `rough-${s}`, a = `rough-${n}`;
    A(`.${s}`).selectAll("path.domain").each(function(h, l) {
  ...
  addInteraction() {
    P(this.interactionG).each(function(n, r) {
      const a = this.attributes;
      A(this).append("rect").attr("x", a.x.value).attr("y", a.y.value).attr("width", a.width.value).attr("height", a.height.value).attr("fill", "transparent");
    });
    const t = A(this.el).append("div").style("opacity", 0).attr("class", "tooltip").style("position", "absolute").style("background-color", "white").style("border", "solid").style("border-width", "1px").style("border-radius", "5px").style("padding", "3px").style("font-family", this.fontFamily).style("font-size", this.tooltipFontSize).style("pointer-events", "none"), i = this;
    let s;
    P(this.interactionG).on("mouseover", function() {
      t.style("opacity", 1), s = A(this).selectAll("path").style("stroke"), A(this).select("path").style("stroke", i.highlight), A(this).selectAll("path:nth-child(2)").style("stroke-width", i.strokeWidth + 1.2);
    }), P(this.interactionG).on("mouseout", function() {
      t.style("opacity", 0), A(this).select("path").style("stroke", s), A(this).selectAll("path:nth-child(2)").style("stroke-width", i.strokeWidth);
    }), P(this.interactionG).on("mousemove", function(n) {
      const r = A(this).attr("attrX"), a = A(this).attr("attrY"), h = wt(this);
      t.html(`<b>${r}</b>: ${a}`).style("opacity", 0.95).attr("class", function(l) {
      }).style("transform", `translate(${h[0] + i.margin.left}px, 
          ${h[1] - (i.height + i.margin.top + i.margin.bottom / 2)}px)`);
    });
  }
  initRoughObjects() {
  ...
  stacking() {
    this.data.forEach((t) => {
      ...
      i.forEach((n, r) => {
        if (r > 0 && n !== "total") {
          s += parseInt(t[n], 10);
          const a = this.xScale(t[this.labels]), h = this.yScale(s), l = this.xScale.bandwidth(), o = this.height - this.yScale(+t[n]), c = this.rc.rectangle(a, h, l, o, { fill: this.stackColorMapping[n] || this.colors[r], stroke: this.stackColorMapping[n] || this.colors[r], simplification: this.simplification, fillWeight: this.fillWeight }), u = this.roughSvg.appendChild(c);
          u.setAttribute("class", this.graphClass), u.setAttribute("attrX", t[this.labels]), u.setAttribute("keyY", n), u.setAttribute("attrY", +t[n]), u.setAttribute("x", a), u.setAttribute("y", h), u.setAttribute("width", l), u.setAttribute("height", o);
        }
      });
    });
  }
