...
<html>
  <head>
    ...
    /> -->
    <!-- <link href="prism-themes/themes/prism-ghcolors.css" rel="stylesheet" />
    <script src="prismjs/prism.js"></script>
    <script src="prismjs/components/prism-html.min.js"></script> -->
    <style>
      .example-container {
        display: grid;
        margin: auto;
  ...
  <body>
    ...
    <div class="menu-container">
      ...
      <div id="menuContainer">
        ...
        <div class="menuItem" onclick="logValue('StackedBar')">StackedBar</div>
      </div>
    </div>
    <div class="example-container">
      <div class="controls">
        <label id="label-fillStyle-slider" for="fillStyle-dropdown"
          >Fill Style:</label
        >
        ...
        <label id="label-stroke-picker" for="stroke-picker"
          >Stroke: #000000</label
        >
        <input type="color" id="stroke-picker" name="stroke" value="#000000" />
        <br />
        ...
        <label id="label-innerStrokeWidth-slider" for="innerStrokeWidth-slider"
    ...
    <div class="detail">
      <p>
        ...
        interactive, "sketchy" plots in the browser. Use these charts where the
        communication goal is to show intent or generality, and not absolute
        precision. Or just because they're fun and look weird!
      </p>
      <h2>Getting Started Is Simple</h2>
      <p>
        <strong>1. Import roughViz.js</strong>: First, import the library via a
    ...
    $ npm install rough-viz </code>
      ...
      <p>
        <strong>2. Create container</strong>: Simply create a container div and
        assign some dimensions (e.g. width and height). By default, the roughViz
        chart will be sized and responsive according to these dimensions.
      </p>
      <pre>
        <code id="codeBlock" class="language-html">
   &lt;div id="viz0" width="500px" height="500px"&gt;&lt;/div&gt;</code>
    </pre>
      <p>
  ...
  new roughViz.Donut(
    {
      ...
      <p>
        ...
        <a href="https://observablehq.com/@jwilber?tab=notebooks">here</a
        >.<br />
        Documentation available in the
        <a href="https://github.com/jwilber/roughViz">GitHub repo</a>.
      </p>
      <br />
