...
let mainViz = new roughViz.Scatter({
  element: anchor,
  data: scatterData,
  roughness: roughnessValue,
  fillStyle: fillStyleValue,
...
function newChart() {
  ...
  if (selectedViz === "StackedBar") {
    mainViz = new roughViz.StackedBar({
      element: anchor,
      data: [
